...
##Performance
- data copy speed really depends only on your NIC(Ethernet) and other factors like how _far_ you are from target and source servers (in terms of nework topology). 
