...
#pprint (os.path.split(os.path.split(os.path.split(os.path.dirname( __file__))[0])[0]))
#os.chdir(d)
#print '##########',os.getcwd()
#from include.v101.host_map import host_map as hmap
hmap_file=os.path.join(d,'include','v101','host_map.py')
print hmap_file
hmap=import_module(hmap_file)
#hmap= hmap.host_map
