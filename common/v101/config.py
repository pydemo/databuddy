...
def set_params(params):
	...
	params['core']['arg_4']={'short':'-5','long':'--arg_5', 'type':str, 'default':'', 'help':'Generic string argument 1.'}
	params['core']['arg_5']={'short':'-6','long':'--arg_6', 'type':str, 'default':'', 'help':'Generic string argument 2.'}
	params['core']['arg_6']={'short':'-7','long':'--arg_7', 'type':str, 'default':'', 'help':'Generic string argument 3.'}
