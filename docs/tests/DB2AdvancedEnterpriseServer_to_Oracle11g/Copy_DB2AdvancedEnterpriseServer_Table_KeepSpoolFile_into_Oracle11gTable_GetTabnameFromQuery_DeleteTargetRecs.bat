::Test name: DB2AdvancedEnterpriseServer_Table KeepSpoolFile
	::Description:	Copy DB2AdvancedEnterpriseServer table into Oracle11gTable GetTabnameFromQuery DeleteTargetRecs.
	::Arguments:
