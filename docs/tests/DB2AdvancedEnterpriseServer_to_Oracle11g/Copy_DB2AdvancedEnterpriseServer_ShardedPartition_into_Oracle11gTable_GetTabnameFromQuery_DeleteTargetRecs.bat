::Test name: DB2AdvancedEnterpriseServer_ShardedPartition
	::Description:	Copy DB2AdvancedEnterpriseServer sharded partition into Oracle11gTable GetTabnameFromQuery DeleteTargetRecs.
	::Arguments:
