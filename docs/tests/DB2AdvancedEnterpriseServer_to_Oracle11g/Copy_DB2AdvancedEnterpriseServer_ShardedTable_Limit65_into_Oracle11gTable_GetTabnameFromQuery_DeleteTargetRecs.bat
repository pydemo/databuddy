::Test name: DB2AdvancedEnterpriseServer_ShardedTable Limit65
	::Description:	Copy only 65 rows from DB2AdvancedEnterpriseServer table into Oracle11gTable GetTabnameFromQuery DeleteTargetRecs.
	::Arguments:
