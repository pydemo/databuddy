::Test name: SAPSybaseASE_ShardedQueryFile
	::Description:	Read SQL from a query file "C:\Python27\data_migrator_1239_mongo\test\v101\query\sybase_query.sql".Copy SAPSybaseASE query results into Oracle11gPartition.
	::Arguments:
