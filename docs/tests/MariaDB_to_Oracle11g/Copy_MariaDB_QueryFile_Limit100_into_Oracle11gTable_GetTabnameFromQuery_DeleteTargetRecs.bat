::Test name: MariaDB_QueryFile Limit100
	::Description:	Read SQL from a query file "C:\Python27\data_migrator_1239_mongo\test\v101\query\mariadb_query.sql".Copy only 100 rows from MariaDB query results into Oracle11gTable GetTabnameFromQuery DeleteTargetRecs.
	::Arguments:
...
-B qc_job ^
-Y 20150616_074406_736000 ^
-1 ".\etl_templates\Oracle\delete_target_recs\job_pre_etl.py" ^
-C ".\config\sqlloader.py" ^
-5 ".\config\host_map_v2.py" ^
-6 csv ^
-q C:\Python27\data_migrator_1239_mongo\test\v101\query\mariadb_query.sql ^
-j "root" ^
-x "maria_pwd" ^
-b "test" ^
-n "localhost" ^
