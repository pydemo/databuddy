::Test name: DB2DeveloperEdition_Partition
	::Description:	Copy DB2DeveloperEdition partition into Oracle11gTable GetTabnameFromQuery DeleteTargetRecs.
	::Arguments:
