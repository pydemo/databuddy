::Test name: InformixInnovatorC_Table Limit15
	::Description:	Copy only 15 rows from InformixInnovatorC table into Oracle11gTable GetTabnameFromQuery DeleteTargetRecs.
	::Arguments:
