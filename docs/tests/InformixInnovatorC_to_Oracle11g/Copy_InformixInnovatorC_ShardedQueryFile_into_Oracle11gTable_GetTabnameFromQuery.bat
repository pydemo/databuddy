::Test name: InformixInnovatorC_ShardedQueryFile
	::Description:	Read SQL from a query file "C:\Python27\data_migrator_1239_mongo\test\v101\query\informix_query.sql".Copy InformixInnovatorC query results into Oracle11gTable GetTabnameFromQuery.
	::Arguments:
