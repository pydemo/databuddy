::Test name: Oracle11g_QueryDir TableNamedFiles
	::Description:	Read each SQL query file from a directory "C:\Python27\data_migrator_1239_mongo\test\v101\query\query_dir_ora_table_named".Copy Oracle11g query results into Oracle11gTable GetTabnameFromQuery DeleteTargetRecs.
	::Arguments:
