::Test name: DB2WorkgroupServer_Partition Limit30
	::Description:	Copy only 30 rows from DB2WorkgroupServer partition into Oracle11gTable GetTabnameFromQuery DeleteTargetRecs.
	::Arguments:
