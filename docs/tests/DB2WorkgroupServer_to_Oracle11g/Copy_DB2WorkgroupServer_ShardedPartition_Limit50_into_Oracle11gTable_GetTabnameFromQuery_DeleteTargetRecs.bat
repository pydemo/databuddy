::Test name: DB2WorkgroupServer_ShardedPartition Limit50
	::Description:	Copy only 50 rows from DB2WorkgroupServer sharded partition into Oracle11gTable GetTabnameFromQuery DeleteTargetRecs.
	::Arguments:
