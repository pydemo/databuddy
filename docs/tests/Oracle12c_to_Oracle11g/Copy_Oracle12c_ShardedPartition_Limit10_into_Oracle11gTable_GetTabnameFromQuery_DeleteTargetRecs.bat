::Test name: Oracle12c_ShardedPartition Limit10
	::Description:	Copy only 10 rows from Oracle12c sharded partition into Oracle11gTable GetTabnameFromQuery DeleteTargetRecs.
	::Arguments:
