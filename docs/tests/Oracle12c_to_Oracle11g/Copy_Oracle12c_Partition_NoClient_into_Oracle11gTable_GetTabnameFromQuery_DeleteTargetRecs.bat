::Test name: Oracle12c_Partition NoClient
	::Description:	Copy Oracle12c partition into Oracle11gTable GetTabnameFromQuery DeleteTargetRecs.
	::Arguments:
...
-e SCOTT ^
-m tiger ^
-O '(DESCRIPTION=(ADDRESS=(PROTOCOL=TCP)(HOST=localhost)(PORT=1521))(CONNECT_DATA=(SERVER=DEDICATED)(SERVICE_NAME=orcl)))' ^
