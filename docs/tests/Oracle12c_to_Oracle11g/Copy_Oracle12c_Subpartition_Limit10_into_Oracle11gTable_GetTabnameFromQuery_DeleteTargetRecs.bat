::Test name: Oracle12c_Subpartition Limit10
	::Description:	Copy only 10 rows from Oracle12c sub-partition into Oracle11gTable GetTabnameFromQuery DeleteTargetRecs.
	::Arguments:
