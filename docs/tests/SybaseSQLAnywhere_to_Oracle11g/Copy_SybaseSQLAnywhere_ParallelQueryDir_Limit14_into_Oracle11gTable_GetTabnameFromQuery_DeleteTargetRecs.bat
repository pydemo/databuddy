::Test name: SybaseSQLAnywhere_ParallelQueryDir Limit14
	::Description:	Read each SQL query file from a directory "-1".Copy only 14 rows from SybaseSQLAnywhere query results into Oracle11gTable GetTabnameFromQuery DeleteTargetRecs.
	::Arguments:
