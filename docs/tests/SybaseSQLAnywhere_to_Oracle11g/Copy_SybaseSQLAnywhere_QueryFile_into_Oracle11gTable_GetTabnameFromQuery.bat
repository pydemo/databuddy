::Test name: SybaseSQLAnywhere_QueryFile
	::Description:	Read SQL from a query file "C:\Python27\data_migrator_1239_mongo\test\v101\query\sybase_query.sql".Copy SybaseSQLAnywhere query results into Oracle11gTable GetTabnameFromQuery.
	::Arguments:
