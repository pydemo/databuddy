::Test name: SybaseSQLAnywhere_QueryFile Limit10
	::Description:	Read SQL from a query file "C:\Python27\data_migrator_1239_mongo\test\v101\query\sybase_query.sql".Copy only 10 rows from SybaseSQLAnywhere query results into Oracle11gTable GetTabnameFromQuery DeleteTargetRecs.
	::Arguments:
