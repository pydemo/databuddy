::Test name: SybaseSQLAnywhere_QueryDir Limit15
	::Description:	Read each SQL query file from a directory "C:\Python27\data_migrator_1239_mongo\test\v101\query\query_dir_sy".Copy only 15 rows from SybaseSQLAnywhere query results into Oracle11gTable SkipHeader.
	::Arguments:
