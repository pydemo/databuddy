::Test name: InformixIDS_ShardedTable Limit66
	::Description:	Copy only 66 rows from InformixIDS table into Oracle11gTable GetTabnameFromQuery DeleteTargetRecs.
	::Arguments:
