::Test name: TimesTen_ParallelQueryDir Limit30
	::Description:	Read each SQL query file from a directory "C:\Python27\data_migrator_1239_mongo\test\v101\query\query_dir_tt".Copy only 30 rows from TimesTen query results into Oracle11gTable TruncateTarget NoClient.
	::Arguments:
