::Test name: TimesTen_QueryDir
	::Description:	Read each SQL query file from a directory "C:\Python27\data_migrator_1239_mongo\test\v101\query\query_dir_tt".Copy TimesTen query results into Oracle11gTable SkipHeader.
	::Arguments:
