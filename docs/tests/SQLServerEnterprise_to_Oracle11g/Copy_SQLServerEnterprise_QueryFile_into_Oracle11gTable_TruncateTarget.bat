::Test name: SQLServerEnterprise_QueryFile
	::Description:	Read SQL from a query file "C:\Python27\data_migrator_1239_mongo\test\v101\query\ss_query.sql".Copy SQLServerEnterprise query results into Oracle11gTable TruncateTarget.
	::Arguments:
