::Test name: JSON_Files noIDs
	::Description:	Load JSON table into Oracle11gTable GetTabnameFromQuery DeleteTargetRecs.
	::Arguments:
...
-B qc_job ^
-Y 20150616_074314_308000 ^
-C ".\config\sqlloader.py" ^
-5 ".\config\host_map_v2.py" ^
-6 json ^
-i C:\Python27\data_migrator_1239_mongo\test\v101\data\JSON_Mongo_Collection_noIDs.js ^
-y 1000 ^
-u SCOTT ^
-p tiger ^
-d orcl ^
