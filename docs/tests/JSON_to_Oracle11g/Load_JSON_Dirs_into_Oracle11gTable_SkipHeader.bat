::Test name: JSON_Dirs
	::Description:	Read each CSV file from a directory "C:\Python27\data_migrator_1239_mongo\test\v101\data\JSON_data_dir".Load JSON table into Oracle11gTable SkipHeader.
	::Arguments:
