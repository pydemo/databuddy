::Test name: DB2ExpressC_Table Limit20
	::Description:	Copy only 20 rows from DB2ExpressC table into Oracle11gTable GetTabnameFromQuery DeleteTargetRecs.
	::Arguments:
