::Test name: DB2ExpressC_ShardedTable Limit65
	::Description:	Copy only 65 rows from DB2ExpressC table into Oracle11gTable GetTabnameFromQuery DeleteTargetRecs.
	::Arguments:
