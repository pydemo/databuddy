::Test name: DB2ExpressC_ShardedPartition Limit50
	::Description:	Copy only 50 rows from DB2ExpressC sharded partition into Oracle11gTable GetTabnameFromQuery DeleteTargetRecs.
	::Arguments:
