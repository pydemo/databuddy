::Test name: Infobright_QueryDir Limit333
	::Description:	Read each SQL query file from a directory "C:\Python27\data_migrator_1239_mongo\test\v101\query\query_dir_mysql".Copy only 333 rows from Infobright query results into Oracle11gTable DeleteTargetRecs.
	::Arguments:
