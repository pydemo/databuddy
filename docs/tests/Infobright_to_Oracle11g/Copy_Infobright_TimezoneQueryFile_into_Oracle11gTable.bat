::Test name: Infobright_TimezoneQueryFile
	::Description:	Read SQL from a query file "C:\Python27\data_migrator_1239_mongo\test\v101\query\mysql_query.sql".Copy Infobright query results into Oracle11gTable.
	::Arguments:
