::Test name: Infobright_Subpartition Limit33
	::Description:	Copy only 33 rows from Infobright sub-partition into Oracle11gTable GetTabnameFromQuery DeleteTargetRecs.
	::Arguments:
