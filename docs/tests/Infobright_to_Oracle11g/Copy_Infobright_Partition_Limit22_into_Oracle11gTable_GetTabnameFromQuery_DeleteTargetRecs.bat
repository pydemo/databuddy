::Test name: Infobright_Partition Limit22
	::Description:	Copy only 22 rows from Infobright partition into Oracle11gTable GetTabnameFromQuery DeleteTargetRecs.
	::Arguments:
