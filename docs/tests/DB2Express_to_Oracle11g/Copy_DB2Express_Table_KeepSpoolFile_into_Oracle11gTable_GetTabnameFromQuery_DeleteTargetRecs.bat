::Test name: DB2Express_Table KeepSpoolFile
	::Description:	Copy DB2Express table into Oracle11gTable GetTabnameFromQuery DeleteTargetRecs.
	::Arguments:
