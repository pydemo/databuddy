::Test name: DB2Express_ShardedPartition
	::Description:	Copy DB2Express sharded partition into Oracle11gTable GetTabnameFromQuery DeleteTargetRecs.
	::Arguments:
