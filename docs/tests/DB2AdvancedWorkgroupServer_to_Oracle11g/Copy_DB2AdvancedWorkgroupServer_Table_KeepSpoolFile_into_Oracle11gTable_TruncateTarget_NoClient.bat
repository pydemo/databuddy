::Test name: DB2AdvancedWorkgroupServer_Table KeepSpoolFile
	::Description:	Copy DB2AdvancedWorkgroupServer table into Oracle11gTable TruncateTarget NoClient.
	::Arguments:
