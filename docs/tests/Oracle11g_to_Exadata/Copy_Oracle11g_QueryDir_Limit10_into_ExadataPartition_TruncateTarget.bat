::Test name: Oracle11g_QueryDir Limit10
	::Description:	Read each SQL query file from a directory "C:\Python27\data_migrator_1239_mongo\test\v101\query\query_dir_ora".Copy only 10 rows from Oracle11g query results into ExadataPartition TruncateTarget.
	::Arguments:
