::Test name: DB2EnterpriseServer_Table Limit20
	::Description:	Copy only 20 rows from DB2EnterpriseServer table into Oracle11gTable GetTabnameFromQuery DeleteTargetRecs.
	::Arguments:
