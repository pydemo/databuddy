::Test name: DB2EnterpriseServer_ShardedPartition
	::Description:	Copy DB2EnterpriseServer sharded partition into Oracle11gTable GetTabnameFromQuery DeleteTargetRecs.
	::Arguments:
