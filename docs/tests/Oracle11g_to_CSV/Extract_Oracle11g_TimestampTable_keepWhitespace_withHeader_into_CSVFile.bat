::Test name: Oracle11g_TimestampTable keepWhitespace withHeader
...
-A 1 ^
-W 1 ^
-g C:\Python27\data_migrator_1239_mongo\CSV_OUT\testORA11G_TimestampTable_keepWhitespace_withHeader.csv