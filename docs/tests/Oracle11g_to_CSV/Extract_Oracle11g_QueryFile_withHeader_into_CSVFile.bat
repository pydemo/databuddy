::Test name: Oracle11g_QueryFile withHeader
	::Description:	Read SQL from a query file "C:\Python27\data_migrator_1239_mongo\test\v101\query\oracle_query.sql".Extract Oracle11g table into CSVFile.
	::Arguments:
...
-A 1 ^
-g C:\Python27\data_migrator_1239_mongo\CSV_OUT\testORA11G_QueryFile_withHeader.csv