::Test name: SybaseIQ_Table KeepSpoolFile
	::Description:	Copy SybaseIQ table into Oracle11gTable GetTabnameFromQuery DeleteTargetRecs.
	::Arguments:
