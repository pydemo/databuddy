::Test name: SybaseIQ_ParallelQueryDir Limit14
	::Description:	Read each SQL query file from a directory "-1".Copy only 14 rows from SybaseIQ query results into Oracle11gTable NoClient.
	::Arguments:
