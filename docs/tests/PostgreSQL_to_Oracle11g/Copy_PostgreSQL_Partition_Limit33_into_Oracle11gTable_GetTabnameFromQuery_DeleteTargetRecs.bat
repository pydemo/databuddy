::Test name: PostgreSQL_Partition Limit33
	::Description:	Copy only 33 rows from PostgreSQL partition into Oracle11gTable GetTabnameFromQuery DeleteTargetRecs.
	::Arguments:
