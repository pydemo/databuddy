::Test name: PostgreSQL_QueryDir
	::Description:	Read each SQL query file from a directory "C:\Python27\data_migrator_1239_mongo\test\v101\query\query_dir_pgres".Copy PostgreSQL query results into Oracle11gTable TruncateTarget.
	::Arguments:
