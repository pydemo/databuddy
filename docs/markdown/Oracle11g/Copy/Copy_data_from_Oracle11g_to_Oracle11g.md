...
# Migrating Oracle11g table data to Oracle11g.
In this example we are going to migrate Oracle11g table data to Oracle11g.
Migration steps:
...
```  
(sample image)
![Define copy vector for Oracle11g-to-Oracle11g extract pipeline](https://raw.githubusercontent.com/data-buddy/DataBuddy/master/screenshots/MongoDB/Define_copy_vector_for_Oracle12c-to-MongoDB_copy_pipeline.png "Define copy vector for Oracle11g-to-Oracle11g copy pipeline.")
...
```
############################################################
2015-06-01 11:30:09,022 - ORA11G-ORA11G - INFO - Done.
2015-06-01 11:30:09,022 - ORA11G-ORA11G - INFO - Elapsed: 00:00:00
