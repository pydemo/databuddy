...
docker rm -f voltdb-demo 2>/dev/null;true && \ docker pull voltdb/voltdb-demo && \ docker run --name voltdb-demo -p 8080:8080 -p 8081:8081 -d voltdb/voltdb-demo - See more at: https://voltdb.com/community/demo#windows```
############################################################
