...
# Migrating PostgreSQL table data to Oracle12c.
In this example we are going to migrate PostgreSQL table data to Oracle12c.
Migration steps:
...
```  
(sample image)
![Define copy vector for PostgreSQL-to-Oracle12c extract pipeline](https://raw.githubusercontent.com/data-buddy/DataBuddy/master/screenshots/MongoDB/Define_copy_vector_for_Oracle12c-to-MongoDB_copy_pipeline.png "Define copy vector for PostgreSQL-to-Oracle12c copy pipeline.")
...
```
############################################################
2015-06-01 11:30:09,022 - PGRES-ORA12C - INFO - Done.
2015-06-01 11:30:09,022 - PGRES-ORA12C - INFO - Elapsed: 00:00:00
