...
# Migrating DDL table data to DB2ExpressC.
In this example we are going to migrate DDL table data to DB2ExpressC.
Migration steps:
...
![Define copy vector for DDL-to-DB2ExpressC extract pipeline](https://raw.githubusercontent.com/data-buddy/DataBuddy/master/screenshots/MongoDB/Define_copy_vector_for_Oracle12c-to-MongoDB_copy_pipeline.png "Define copy vector for DDL-to-DBTEC copy pipeline.")

## Select Source and Target templates
Next and last step is template selection. Pick one from the source list on the left (`DDL_TimestampTable`) and one from the target list on the right (`DBTEC_Table`):
...
```
############################################################
2015-06-01 11:30:09,022 - DDL-DBTEC - INFO - Done.
2015-06-01 11:30:09,022 - DDL-DBTEC - INFO - Elapsed: 00:00:00
