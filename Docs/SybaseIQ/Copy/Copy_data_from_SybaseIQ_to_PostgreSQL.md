...
# Migrating SybaseIQ table data to PostgreSQL.
In this example we are going to migrate SybaseIQ table data to PostgreSQL.
Migration steps:
...
```  
(sample image)
![Define copy vector for SybaseIQ-to-PostgreSQL extract pipeline](https://raw.githubusercontent.com/data-buddy/DataBuddy/master/screenshots/MongoDB/Define_copy_vector_for_Oracle12c-to-MongoDB_copy_pipeline.png "Define copy vector for SYIQ-to-PGRES copy pipeline.")

## Select Source and Target templates
Next and last step is template selection. Pick one from the source list on the left (`SYIQ_TimestampTable`) and one from the target list on the right (`PGRES_Table`):
(sample image)
...
```
############################################################
2015-06-01 11:30:09,022 - SYIQ-PGRES - INFO - Done.
2015-06-01 11:30:09,022 - SYIQ-PGRES - INFO - Elapsed: 00:00:00
