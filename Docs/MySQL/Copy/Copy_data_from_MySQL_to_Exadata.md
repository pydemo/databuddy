...
```  
(sample image)
![Define copy vector for MySQL-to-Exadata extract pipeline](https://raw.githubusercontent.com/data-buddy/DataBuddy/master/screenshots/MongoDB/Define_copy_vector_for_Oracle12c-to-MongoDB_copy_pipeline.png "Define copy vector for MYSQL-to-ORAEXA copy pipeline.")
