...
# Migrating InformixIDS table data to OracleXE.
In this example we are going to migrate InformixIDS table data to OracleXE.
Migration steps:
...
```  
(sample image)
![Define copy vector for InformixIDS-to-OracleXE extract pipeline](https://raw.githubusercontent.com/data-buddy/DataBuddy/master/screenshots/MongoDB/Define_copy_vector_for_Oracle12c-to-MongoDB_copy_pipeline.png "Define copy vector for InformixIDS-to-OracleXE copy pipeline.")

## Select Source and Target templates
Next and last step is template selection. Pick one from the source list on the left (`INFOR_TimestampTable`) and one from the target list on the right (`ORAXE_Table`):
(sample image)
...
```
############################################################
2015-06-01 11:30:09,022 - INFOR-ORAXE - INFO - Done.
2015-06-01 11:30:09,022 - INFOR-ORAXE - INFO - Elapsed: 00:00:00
