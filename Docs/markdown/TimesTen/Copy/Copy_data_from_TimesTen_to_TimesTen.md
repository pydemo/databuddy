...
# Migrating TimesTen table data to TimesTen.
In this example we are going to migrate TimesTen table data to TimesTen.
Migration steps:
...
```
############################################################
2015-06-01 11:30:09,022 - TTEN-TTEN - INFO - Done.
2015-06-01 11:30:09,022 - TTEN-TTEN - INFO - Elapsed: 00:00:00
