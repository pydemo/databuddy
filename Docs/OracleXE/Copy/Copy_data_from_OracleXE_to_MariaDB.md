...
# Migrating OracleXE table data to MariaDB.
In this example we are going to migrate OracleXE table data to MariaDB.
Migration steps:
...
```  
(sample image)
![Define copy vector for OracleXE-to-MariaDB extract pipeline](https://raw.githubusercontent.com/data-buddy/DataBuddy/master/screenshots/MongoDB/Define_copy_vector_for_Oracle12c-to-MongoDB_copy_pipeline.png "Define copy vector for OracleXE-to-MariaDB copy pipeline.")

## Select Source and Target templates
Next and last step is template selection. Pick one from the source list on the left (`ORAXE_TimestampTable`) and one from the target list on the right (`MARIA_Table`):
(sample image)
...
```
############################################################
2015-06-01 11:30:09,022 - ORAXE-MARIA - INFO - Done.
2015-06-01 11:30:09,022 - ORAXE-MARIA - INFO - Elapsed: 00:00:00
