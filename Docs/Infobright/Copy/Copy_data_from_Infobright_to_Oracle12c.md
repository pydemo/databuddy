...
# Migrating Infobright table data to Oracle12c.
In this example we are going to migrate Infobright table data to Oracle12c.
Migration steps:
...
```  
(sample image)
![Define copy vector for Infobright-to-Oracle12c extract pipeline](https://raw.githubusercontent.com/data-buddy/DataBuddy/master/screenshots/MongoDB/Define_copy_vector_for_Oracle12c-to-MongoDB_copy_pipeline.png "Define copy vector for INFOB-to-ORA12C copy pipeline.")

## Select Source and Target templates
Next and last step is template selection. Pick one from the source list on the left (`INFOB_TimestampTable`) and one from the target list on the right (`ORA12C_Table`):
(sample image)
...
```
############################################################
2015-06-01 11:30:09,022 - INFOB-ORA12C - INFO - Done.
2015-06-01 11:30:09,022 - INFOB-ORA12C - INFO - Elapsed: 00:00:00
