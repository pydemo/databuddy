...
# Migrating DB2ExpressC table data to DB2ExpressC.
In this example we are going to migrate DB2ExpressC table data to DB2ExpressC.
Migration steps:
...
```
############################################################
2015-06-01 11:30:09,022 - DBTEC-DBTEC - INFO - Done.
2015-06-01 11:30:09,022 - DBTEC-DBTEC - INFO - Elapsed: 00:00:00
