...
# Migrating DB2AdvancedWorkgroupServer table data to DDL.
In this example we are going to migrate DB2AdvancedWorkgroupServer table data to DDL.
Migration steps:
...
![Define copy vector for DB2AdvancedWorkgroupServer-to-DDL extract pipeline](https://raw.githubusercontent.com/data-buddy/DataBuddy/master/screenshots/MongoDB/Define_copy_vector_for_Oracle12c-to-MongoDB_copy_pipeline.png "Define copy vector for DBTAWS-to-DDL copy pipeline.")

## Select Source and Target templates
Next and last step is template selection. Pick one from the source list on the left (`DBTAWS_TimestampTable`) and one from the target list on the right (`DDL_Table`):
...
```
############################################################
2015-06-01 11:30:09,022 - DBTAWS-DDL - INFO - Done.
2015-06-01 11:30:09,022 - DBTAWS-DDL - INFO - Elapsed: 00:00:00
