...
```
Status `Done.` means good news. CSV export file is at `C:\Python27\data_migrator_1239_12c\CSV_OUT\testSSEXP_Table.data` as defined by __Target__ `to_file` argument.
