::Test name: CSV_Dirs Limit10
	::Description:	Read each CSV file from a directory "C:\Python27\data_migrator_1239_mongo\test\v101\data\ora_data_dir_1;C:\Python27\data_migrator_1239_mongo\test\v101\data\ora_data_dir_2".Load only 10 rows from CSV file into Oracle11gTable SkipHeader.
	::Arguments:
