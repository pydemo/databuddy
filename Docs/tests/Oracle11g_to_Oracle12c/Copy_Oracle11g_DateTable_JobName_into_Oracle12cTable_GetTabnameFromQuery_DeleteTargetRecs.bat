::Test name: Oracle11g_DateTable JobName
	::Description:	Copy Oracle11g table into Oracle12cTable GetTabnameFromQuery DeleteTargetRecs.
	::Arguments:
...
-B FROM_ORA11G_DateTable_JobName_TO_ORA12C_Table_GetTabnameFromQuery_DeleteTargetRecs ^
-Y 20150616_074312_195000 ^
