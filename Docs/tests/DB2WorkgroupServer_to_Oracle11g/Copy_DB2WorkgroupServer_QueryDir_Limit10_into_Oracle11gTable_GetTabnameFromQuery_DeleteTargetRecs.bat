::Test name: DB2WorkgroupServer_QueryDir Limit10
	::Description:	Read each SQL query file from a directory "C:\Python27\data_migrator_1239_mongo\test\v101\query\query_dir_db2".Copy only 10 rows from DB2WorkgroupServer query results into Oracle11gTable GetTabnameFromQuery DeleteTargetRecs.
	::Arguments:
