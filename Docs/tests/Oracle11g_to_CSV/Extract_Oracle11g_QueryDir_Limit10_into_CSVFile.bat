::Test name: Oracle11g_QueryDir Limit10
	::Description:	Read each SQL query file from a directory "C:\Python27\data_migrator_1239_mongo\test\v101\query\query_dir_ora".Extract only 10 rows from Oracle11g table into CSVFile.
	::Arguments:
...
-g C:\Python27\data_migrator_1239_mongo\CSV_OUT\testORA11G_QueryDir_Limit10.csv