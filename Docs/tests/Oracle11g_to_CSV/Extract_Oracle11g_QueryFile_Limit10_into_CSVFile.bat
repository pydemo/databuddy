::Test name: Oracle11g_QueryFile Limit10
	::Description:	Read SQL from a query file "C:\Python27\data_migrator_1239_mongo\test\v101\query\oracle_query.sql".Extract only 10 rows from Oracle11g table into CSVFile.
	::Arguments:
...
-g C:\Python27\data_migrator_1239_mongo\CSV_OUT\testORA11G_QueryFile_Limit10.csv