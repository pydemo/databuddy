::Test name: SybaseIQ_ParallelQueryDir
	::Description:	Read each SQL query file from a directory "-1".Copy SybaseIQ query results into Oracle11gTable GetTabnameFromQuery DeleteTargetRecs.
	::Arguments:
