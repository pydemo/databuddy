::Test name: DB2DeveloperEdition_ShardedPartition Limit50
	::Description:	Copy only 50 rows from DB2DeveloperEdition sharded partition into Oracle11gTable GetTabnameFromQuery DeleteTargetRecs.
	::Arguments:
