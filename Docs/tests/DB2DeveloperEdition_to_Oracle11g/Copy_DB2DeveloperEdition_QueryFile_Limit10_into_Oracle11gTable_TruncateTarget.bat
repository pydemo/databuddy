::Test name: DB2DeveloperEdition_QueryFile Limit10
	::Description:	Read SQL from a query file "C:\Python27\data_migrator_1239_mongo\test\v101\query\db2_query.sql".Copy only 10 rows from DB2DeveloperEdition query results into Oracle11gTable TruncateTarget.
	::Arguments:
