::Test name: PostgreSQL_Table KeepSpoolFile
	::Description:	Copy PostgreSQL table into Oracle11gTable GetTabnameFromQuery DeleteTargetRecs.
	::Arguments:
