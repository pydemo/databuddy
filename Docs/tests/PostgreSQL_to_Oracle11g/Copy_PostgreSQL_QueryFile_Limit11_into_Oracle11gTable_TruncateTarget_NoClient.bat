::Test name: PostgreSQL_QueryFile Limit11
	::Description:	Read SQL from a query file "C:\Python27\data_migrator_1239_mongo\test\v101\query\postgre_query.sql".Copy only 11 rows from PostgreSQL query results into Oracle11gTable TruncateTarget NoClient.
	::Arguments:
