::Test name: DB2AdvancedEnterpriseServer_ShardedPartition Limit50
	::Description:	Copy only 50 rows from DB2AdvancedEnterpriseServer sharded partition into Oracle11gTable GetTabnameFromQuery DeleteTargetRecs.
	::Arguments:
