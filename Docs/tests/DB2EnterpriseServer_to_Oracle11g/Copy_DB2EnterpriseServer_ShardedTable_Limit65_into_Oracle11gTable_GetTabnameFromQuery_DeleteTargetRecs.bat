::Test name: DB2EnterpriseServer_ShardedTable Limit65
	::Description:	Copy only 65 rows from DB2EnterpriseServer table into Oracle11gTable GetTabnameFromQuery DeleteTargetRecs.
	::Arguments:
