::Test name: DB2EnterpriseServer_ParallelQueryDir
	::Description:	Read each SQL query file from a directory "C:\Python27\data_migrator_1239_mongo\test\v101\query\query_dir_db2".Copy DB2EnterpriseServer query results into Oracle11gSubpartition.
	::Arguments:
