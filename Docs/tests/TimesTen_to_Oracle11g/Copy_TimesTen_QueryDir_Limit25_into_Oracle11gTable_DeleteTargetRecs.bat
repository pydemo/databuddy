::Test name: TimesTen_QueryDir Limit25
	::Description:	Read each SQL query file from a directory "C:\Python27\data_migrator_1239_mongo\test\v101\query\query_dir_tt".Copy only 25 rows from TimesTen query results into Oracle11gTable DeleteTargetRecs.
	::Arguments:
