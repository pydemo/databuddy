::Test name: InformixInnovatorC_ParallelQueryDir
	::Description:	Read each SQL query file from a directory "C:\Python27\data_migrator_1239_mongo\test\v101\query\query_dir_infor".Copy InformixInnovatorC query results into Oracle11gPartition.
	::Arguments:
