::Test name: InformixInnovatorC_QueryFile Limit20
	::Description:	Read SQL from a query file "C:\Python27\data_migrator_1239_mongo\test\v101\query\informix_query.sql".Copy only 20 rows from InformixInnovatorC query results into Oracle11gTable NoClient.
	::Arguments:
