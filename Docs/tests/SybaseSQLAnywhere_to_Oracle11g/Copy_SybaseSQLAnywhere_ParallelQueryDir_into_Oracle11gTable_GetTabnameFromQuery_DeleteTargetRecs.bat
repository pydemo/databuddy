::Test name: SybaseSQLAnywhere_ParallelQueryDir
	::Description:	Read each SQL query file from a directory "-1".Copy SybaseSQLAnywhere query results into Oracle11gTable GetTabnameFromQuery DeleteTargetRecs.
	::Arguments:
