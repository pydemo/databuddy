::Test name: Oracle11g_ShardedQueryDir withHeader
	::Description:	Read each SQL query file from a directory "C:\Python27\data_migrator_1239_mongo\test\v101\query\query_dir_ora".Copy Oracle11g query results into ExadataTable TruncateTarget NoClient.
	::Arguments:
