::Test name: Oracle12c_ShardedSubpartition
	::Description:	Copy Oracle12c sharded sub-partition into Oracle11gTable GetTabnameFromQuery DeleteTargetRecs.
	::Arguments:
