::Test name: Oracle12c_QueryFile trimWhitespace withHeader
	::Description:	Read SQL from a query file "C:\Python27\data_migrator_1239_mongo\test\v101\query\oracle_query.sql".Copy Oracle12c query results into Oracle11gTable.
	::Arguments:
