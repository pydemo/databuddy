::Test name: Oracle12c_SubpartitionList
	::Description:	Copy Oracle12c sub-partition into Oracle11gTable GetTabnameFromQuery DeleteTargetRecs.
	::Arguments:
...
-B qc_job ^
-Y 20150616_074354_429000 ^
-C ".\config\sqlloader.py" ^
-5 ".\config\host_map_v2.py" ^
-6 csv ^
-c SCOTT.Sub_Partitioned_test_from ^
-b part_15_sp1,part_15_sp2,part_14_sp1,part_14_sp2 ^
-e SCOTT ^
-m tiger ^
-O orcl ^
