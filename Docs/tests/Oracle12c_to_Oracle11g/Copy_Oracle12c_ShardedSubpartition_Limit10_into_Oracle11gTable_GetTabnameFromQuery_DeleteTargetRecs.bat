::Test name: Oracle12c_ShardedSubpartition Limit10
	::Description:	Copy only 10 rows from Oracle12c sharded sub-partition into Oracle11gTable GetTabnameFromQuery DeleteTargetRecs.
	::Arguments:
