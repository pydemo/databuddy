::Test name: Infobright_QueryDir
	::Description:	Read each SQL query file from a directory "C:\Python27\data_migrator_1239_mongo\test\v101\query\query_dir_mysql".Copy Infobright query results into Oracle11gPartition.
	::Arguments:
