...
# Migrating PostgreSQL table data to SybaseSQLAnywhere.
In this example we are going to migrate PostgreSQL table data to SybaseSQLAnywhere.
Migration steps:
...
```  
(sample image)
![Define copy vector for PostgreSQL-to-SybaseSQLAnywhere extract pipeline](https://raw.githubusercontent.com/data-buddy/DataBuddy/master/screenshots/MongoDB/Define_copy_vector_for_Oracle12c-to-MongoDB_copy_pipeline.png "Define copy vector for PostgreSQL-to-SybaseSQLAnywhere copy pipeline.")

## Select Source and Target templates
Next and last step is template selection. Pick one from the source list on the left (`PGRES_TimestampTable`) and one from the target list on the right (`SYANY_Table`):
(sample image)
...
```
############################################################
2015-06-01 11:30:09,022 - PGRES-SYANY - INFO - Done.
2015-06-01 11:30:09,022 - PGRES-SYANY - INFO - Elapsed: 00:00:00
