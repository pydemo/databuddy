...
# Migrating PostgreSQL table data to DB2EnterpriseServer.
In this example we are going to migrate PostgreSQL table data to DB2EnterpriseServer.
Migration steps:
...
```  
(sample image)
![Define copy vector for PostgreSQL-to-DB2EnterpriseServer extract pipeline](https://raw.githubusercontent.com/data-buddy/DataBuddy/master/screenshots/MongoDB/Define_copy_vector_for_Oracle12c-to-MongoDB_copy_pipeline.png "Define copy vector for PGRES-to-DBTES copy pipeline.")

## Select Source and Target templates
Next and last step is template selection. Pick one from the source list on the left (`PGRES_TimestampTable`) and one from the target list on the right (`DBTES_Table`):
(sample image)
...
```
############################################################
2015-06-01 11:30:09,022 - PGRES-DBTES - INFO - Done.
2015-06-01 11:30:09,022 - PGRES-DBTES - INFO - Elapsed: 00:00:00
