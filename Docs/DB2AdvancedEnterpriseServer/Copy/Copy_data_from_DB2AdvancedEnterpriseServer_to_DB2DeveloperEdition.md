...
# Migrating DB2AdvancedEnterpriseServer table data to DB2DeveloperEdition.
In this example we are going to migrate DB2AdvancedEnterpriseServer table data to DB2DeveloperEdition.
Migration steps:
...
![Define copy vector for DB2AdvancedEnterpriseServer-to-DB2DeveloperEdition extract pipeline](https://raw.githubusercontent.com/data-buddy/DataBuddy/master/screenshots/MongoDB/Define_copy_vector_for_Oracle12c-to-MongoDB_copy_pipeline.png "Define copy vector for DBTAES-to-DBTDE copy pipeline.")

## Select Source and Target templates
Next and last step is template selection. Pick one from the source list on the left (`DBTAES_TimestampTable`) and one from the target list on the right (`DBTDE_Table`):
...
```
############################################################
2015-06-01 11:30:09,022 - DBTAES-DBTDE - INFO - Done.
2015-06-01 11:30:09,022 - DBTAES-DBTDE - INFO - Elapsed: 00:00:00
