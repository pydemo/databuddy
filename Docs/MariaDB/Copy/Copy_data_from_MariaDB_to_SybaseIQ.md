...
# Migrating MariaDB table data to SybaseIQ.
In this example we are going to migrate MariaDB table data to SybaseIQ.
Migration steps:
...
```  
(sample image)
![Define copy vector for MariaDB-to-SybaseIQ extract pipeline](https://raw.githubusercontent.com/data-buddy/DataBuddy/master/screenshots/MongoDB/Define_copy_vector_for_Oracle12c-to-MongoDB_copy_pipeline.png "Define copy vector for MariaDB-to-SybaseIQ copy pipeline.")

## Select Source and Target templates
Next and last step is template selection. Pick one from the source list on the left (`MARIA_TimestampTable`) and one from the target list on the right (`SYIQ_Table`):
(sample image)
...
```
############################################################
2015-06-01 11:30:09,022 - MARIA-SYIQ - INFO - Done.
2015-06-01 11:30:09,022 - MARIA-SYIQ - INFO - Elapsed: 00:00:00
