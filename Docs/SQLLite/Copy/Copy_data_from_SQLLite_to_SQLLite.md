...
# Migrating SQLLite table data to SQLLite.
In this example we are going to migrate SQLLite table data to SQLLite.
Migration steps:
...
```
############################################################
2015-06-01 11:30:09,022 - SLITE-SLITE - INFO - Done.
2015-06-01 11:30:09,022 - SLITE-SLITE - INFO - Elapsed: 00:00:00
