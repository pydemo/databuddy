...
# Migrating DB2Express table data to DB2AdvancedEnterpriseServer.
In this example we are going to migrate DB2Express table data to DB2AdvancedEnterpriseServer.
Migration steps:
...
![Define copy vector for DB2Express-to-DB2AdvancedEnterpriseServer extract pipeline](https://raw.githubusercontent.com/data-buddy/DataBuddy/master/screenshots/MongoDB/Define_copy_vector_for_Oracle12c-to-MongoDB_copy_pipeline.png "Define copy vector for DBTE-to-DBTAES copy pipeline.")

## Select Source and Target templates
Next and last step is template selection. Pick one from the source list on the left (`DBTE_TimestampTable`) and one from the target list on the right (`DBTAES_Table`):
...
```
############################################################
2015-06-01 11:30:09,022 - DBTE-DBTAES - INFO - Done.
2015-06-01 11:30:09,022 - DBTE-DBTAES - INFO - Elapsed: 00:00:00
