...
def create_run_tests(db_from, db_to, test,citi=False):
	...
	tfrom['CSV_File_NoTable']= 			( tablenamed_file, None, 0,	1000)
	tfrom['CSV_Files_NoTable']= 			( '%s,%s' % (tablenamed_file,tablenamed_file_2) , None, 0,	1000)
	...
	for dbkey in ('ORA12C','ORA11G','ORA10G','ORA9I','ORA8I','ORA733', 'ORAEXA'):
		...
		tfrom['%s_Table_withHeader' % dbkey]= (None,None,'%s.%s' % (ora_user, from_table), None, None,None,None,None,	 ora_user, ora_pwd, ora_sid,nls_d, nls_t, nls_tz,   0,0)
		...
		tfrom['%s_Partition' % dbkey]= (None,None,'%s.%s' % (ora_user, from_table) , None, orapart,None,None, None, ora_user, ora_pwd, ora_sid,nls_d, nls_t,  nls_tz,   0,0)
		tfrom['%s_Partition_WithWideRows' % dbkey]= (None,None,'%s.%s' % (ora_user, from_table) ,None,  orapart,None, None, None,ora_user, ora_pwd, ora_sid,nls_d, nls_t,  nls_tz,   0,0)
		tfrom['%s_Partition_NoClient' % dbkey]= (None,None,'%s.%s' % (ora_user, from_table) , None, orapart,None,None,None, 	ora_user, ora_pwd, noclient_connect_string,nls_d, nls_t,  nls_tz,   0,0)
		tfrom['%s_Partition_TruncateTarget_AskToTruncate' % dbkey]= (None,None,'%s.%s' % (ora_user, from_table) ,None,  orapart,None,None,None, 	 ora_user, ora_pwd, ora_sid,nls_d, nls_t,  nls_tz,   0,0)
		tfrom['%s_Partition_withHeader' % dbkey]= (None,None,'%s.%s' % (ora_user, from_table) ,None,  orapart,None,None, None, 	 ora_user, ora_pwd, ora_sid,nls_d, nls_t,  nls_tz,   1,0)
		tfrom['%s_Partition_Validate' % dbkey]= (None,None,'%s.%s' % (ora_user, from_table) ,None, orapart,None,None,None, 	 ora_user, ora_pwd, ora_sid,nls_d, nls_t,  nls_tz,   0,0)
		tfrom['%s_Partition_keepWhitespace' % dbkey]= (None,None,'%s.%s' % (ora_user, from_table) , None, orapart,None,None,None,  ora_user, ora_pwd, ora_sid,nls_d, nls_t,  nls_tz,   0,1)
		tfrom['%s_Partition_trimWhitespace' % dbkey]= (None,None,'%s.%s' % (ora_user, from_table) ,None,  orapart,None,None,None, 	 ora_user, ora_pwd, ora_sid,nls_d, nls_t,  nls_tz,   0,0)
		tfrom['%s_Partition_KeepSpoolFile' % dbkey]= (None,None,'%s.%s' % (ora_user, from_table) , None, orapart,None,None,None, 	 ora_user, ora_pwd, ora_sid,nls_d, nls_t,  nls_tz,   0,0)
		...
		tfrom['%s_ShardedPartition' % dbkey]= (None,None,'%s.%s' % (ora_user, from_table) ,None,  orapart,None,None,	None,  ora_user, ora_pwd, ora_sid,nls_d, nls_t, nls_tz,    0,0)
		...
		tfrom['%s_PartitionList' % dbkey]= (None,None,'%s.%s' % (ora_user, from_table) , None, None,'part_13,part_14,part_15,part_16' ,None, None, ora_user, ora_pwd, ora_sid,nls_d, nls_t,  nls_tz,   0,0)
		
		tfrom['%s_Parallel_PartitionList' % dbkey]= (None,None,'%s.%s' % (ora_user, from_table) , None, None,'part_13,part_14,part_15,part_16' ,None,None,  ora_user, ora_pwd, ora_sid,nls_d, nls_t,  nls_tz,   0,0)
		
		tfrom['%s_Subpartition' % dbkey]= (None,None,'%s.%s' % (ora_user, from_table) ,None,  None,None, oraspart,None, 	ora_user, ora_pwd, ora_sid,nls_d, nls_t,  nls_tz,   0,0)
		tfrom['%s_Subpartition_WithWideRows' % dbkey]= (None,None,'%s.%s' % (ora_user, from_table) ,None,  None,None, oraspart,	None, ora_user, ora_pwd, ora_sid,nls_d, nls_t,  nls_tz,   0,0)
		tfrom['%s_Subpartition_withHeader' % dbkey]= (None,None,'%s.%s' % (ora_user, from_table) , None,None,None,  oraspart,None, 	ora_user, ora_pwd, ora_sid,nls_d, nls_t,  nls_tz,   1,0)
		tfrom['%s_Subpartition_Validate' % dbkey]= (None,None,'%s.%s' % (ora_user, from_table) , None, None,None, oraspart,None, ora_user, ora_pwd, ora_sid,nls_d, nls_t,  nls_tz,   0,0)
		tfrom['%s_Subpartition_keepWhitespace' % dbkey]= (None,None,'%s.%s' % (ora_user, from_table) , None, None,None, oraspart,None, 	ora_user, ora_pwd, ora_sid,nls_d, nls_t,  nls_tz,   0,1)
		tfrom['%s_Subpartition_KeepSpoolFile' % dbkey]= (None,None,'%s.%s' % (ora_user, from_table) , None,None, None, oraspart,None, ora_user, ora_pwd, ora_sid,nls_d, nls_t, nls_tz,    0,0)
		...
		tfrom['%s_ShardedSubpartition' % dbkey]= (None,None,'%s.%s' % (ora_user, from_table),None,None,  None,oraspart,	None, ora_user, ora_pwd, ora_sid,nls_d, nls_t,  nls_tz,   0,0)
		...
		tfrom['%s_SubpartitionList' % dbkey]= (None,None,'%s.%s' % (ora_user, from_table) ,None,  None,None, None,'%s,%s,%s,%s' % (oraspart,'part_15_sp2','part_14_sp1','part_14_sp2'), 	ora_user, ora_pwd, ora_sid,nls_d, nls_t,  nls_tz,   0,0)					
		tfrom['%s_Parallel_SubpartitionList' % dbkey]= (None,None,'%s.%s' % (ora_user, from_table) ,None,  None,None, None,'%s,%s,%s,%s' % (oraspart,'part_10_sp2','part_14_sp1','part_14_sp2'), 	ora_user, ora_pwd, ora_sid,nls_d, nls_t,  nls_tz,   0,0)					
