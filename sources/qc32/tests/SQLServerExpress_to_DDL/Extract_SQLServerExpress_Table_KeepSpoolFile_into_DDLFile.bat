::Test name: SQLServerExpress_Table KeepSpoolFile
	::Description:	Extract SQLServerExpress table into DDLFile.
	::Arguments:
...
-g c:\Python27\data_migrator_1239_mongo\DDL_OUT\testSSEXP_Table_KeepSpoolFile.ddl