::Test name: SQLServerExpress_QueryDir Limit25
	::Description:	Read each SQL query file from a directory "C:\Python27\data_migrator_1239_mongo\test\v101\query\query_dir_ss".Copy only 25 rows from SQLServerExpress query results into Oracle9iTable TruncateTarget NoClient.
	::Arguments:
...
::	-u[--to_user] is "Target Oracle 9i db user."
::	-p[--to_passwd] is "Oracle 9i user password."
::	-d[--to_db_name] is "Oracle 9i database."
