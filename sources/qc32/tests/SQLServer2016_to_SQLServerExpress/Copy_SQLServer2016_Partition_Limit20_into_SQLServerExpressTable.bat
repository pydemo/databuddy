::Test name: SQLServer2016_Partition Limit20
	::Description:	Copy only 20 rows from SQLServer2016 partition into SQLServerExpressTable.
	::Arguments:
