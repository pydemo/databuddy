::Test name: Oracle7.3.3_Parallel PartitionList
	::Description:	Copy Oracle7.3.3 partition into SQLServerExpressTable.
	::Arguments:
...
::	-Pl[--from_partition_list] is "(From) Coma separated partition list."
...
-B qc_job ^
-Y 20150908_192609_716000 ^
-5 ".\config\host_map\host_map.py" ^
-6 csv ^
-dbg 1 ^
-c SCOTT.Partitioned_test_from ^
-Pl part_13,part_14,part_15,part_16 ^
-j SCOTT ^
-x tiger ^
-b orcl ^
