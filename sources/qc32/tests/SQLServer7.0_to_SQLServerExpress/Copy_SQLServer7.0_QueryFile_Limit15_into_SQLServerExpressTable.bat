::Test name: SQLServer7.0_QueryFile Limit15
	::Description:	Read SQL from a query file "C:\Python27\data_migrator_1239_mongo\test\v101\query\ss_query.sql".Copy only 15 rows from SQLServer7.0 query results into SQLServerExpressTable.
	::Arguments:
...
::	-q[--query_sql_file] is "Input file with SQL Server 7.0 query sql."
