::Test name: SQLServer2008_QueryDir Limit25
	::Description:	Read each SQL query file from a directory "C:\Python27\data_migrator_1239_mongo\test\v101\query\query_dir_ss".Copy only 25 rows from SQLServer2008 query results into SQLServerExpressTable.
	::Arguments:
...
::	-Q[--query_sql_dir] is "Input dir with SQL Server 2008 query sqls."
