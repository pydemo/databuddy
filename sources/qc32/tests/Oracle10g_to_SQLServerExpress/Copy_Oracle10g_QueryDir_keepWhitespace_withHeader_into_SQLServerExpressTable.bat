::Test name: Oracle10g_QueryDir keepWhitespace withHeader
	::Description:	Read each SQL query file from a directory "C:\Python27\data_migrator_1239_mongo\test\v101\query\query_dir_ora".Copy Oracle10g query results into SQLServerExpressTable.
	::Arguments:
...
::	-Q[--query_sql_dir] is "Input dir with Oracle 10g query files sql."
...
::	-A[--header] is "Include header to Oracle 10g extract."
