...
::	-o[--output] is "Write output to <file> instead of stdout."
::	-url[--url] is "URL to work with."
...
-B qc_job ^
-Y 20150908_192622_954000 ^
-5 ".\config\host_map\host_map.py" ^
-6 csv ^
-dbg 1 ^
-o C:\tmp\curl_out\OATSReportableSecurities-SOD.txt ^
