::Test name: Curl_UrlFiles
	::Description:	Copy Curl table into SQLServerExpressTable.
	::Arguments:
...
::	-urlfiles[--url_files] is "Coma separated list of input files containing URLs."
...
-B qc_job ^
-Y 20150908_192622_933000 ^
-5 ".\config\host_map\host_map.py" ^
-6 csv ^
-dbg 1 ^
-urlfiles C:\Python27\data_migrator_1239_mongo\test\v101\data\url_list.txt,C:\Python27\data_migrator_1239_mongo\test\v101\data\url_list.txt ^
-u sa ^
-p 198Morgan ^
-d master ^
