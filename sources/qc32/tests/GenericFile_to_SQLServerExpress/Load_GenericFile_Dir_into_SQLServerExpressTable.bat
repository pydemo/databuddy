::Test name: GenericFile_Dir
	::Description:	Read each CSV file from a directory "C:\tmp\qctest".Load GenericFile table into SQLServerExpressTable.
	::Arguments:
