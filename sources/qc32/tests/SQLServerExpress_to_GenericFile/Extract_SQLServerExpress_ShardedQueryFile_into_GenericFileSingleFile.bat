::Test name: SQLServerExpress_ShardedQueryFile
	::Description:	Read SQL from a query file "C:\Python27\data_migrator_1239_mongo\test\v101\query\ss_query.sql".Extract SQLServerExpress query results into GenericFileSingleFile.
	::Arguments:
...
-g C:\Python27\data_migrator_1239_mongo\CSV_OUT\testSSEXP_ShardedQueryFile.csv