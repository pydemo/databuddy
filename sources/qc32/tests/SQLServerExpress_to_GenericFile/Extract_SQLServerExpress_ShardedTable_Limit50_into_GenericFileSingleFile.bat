::Test name: SQLServerExpress_ShardedTable Limit50
	::Description:	Extract only 50 rows from SQLServerExpress table into GenericFileSingleFile.
	::Arguments:
...
-g C:\Python27\data_migrator_1239_mongo\CSV_OUT\testSSEXP_ShardedTable_Limit50.csv