::Test name: DB2AdvancedEnterpriseServer_Table Limit20
	::Description:	Copy only 20 rows from DB2AdvancedEnterpriseServer table into Oracle11gTable GetTabnameFromQuery DeleteTargetRecs.
	::Arguments:
