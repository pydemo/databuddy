::Test name: DB2AdvancedEnterpriseServer_Partition Limit30
	::Description:	Copy only 30 rows from DB2AdvancedEnterpriseServer partition into Oracle11gTable GetTabnameFromQuery DeleteTargetRecs.
	::Arguments:
