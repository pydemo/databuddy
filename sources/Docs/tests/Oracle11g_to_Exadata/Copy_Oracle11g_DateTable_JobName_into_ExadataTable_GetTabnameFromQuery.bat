::Test name: Oracle11g_DateTable JobName
	::Description:	Copy Oracle11g table into ExadataTable GetTabnameFromQuery.
	::Arguments:
...
-B FROM_ORA11G_DateTable_JobName_TO_ORAEXA_Table_GetTabnameFromQuery ^
-Y 20150616_074405_526000 ^
