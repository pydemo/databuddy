::Test name: MariaDB_Table Limit1000
	::Description:	Copy only 1000 rows from MariaDB table into Oracle11gTable GetTabnameFromQuery DeleteTargetRecs.
	::Arguments:
