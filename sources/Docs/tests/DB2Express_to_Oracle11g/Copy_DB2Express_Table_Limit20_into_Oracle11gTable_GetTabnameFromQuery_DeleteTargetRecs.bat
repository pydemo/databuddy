::Test name: DB2Express_Table Limit20
	::Description:	Copy only 20 rows from DB2Express table into Oracle11gTable GetTabnameFromQuery DeleteTargetRecs.
	::Arguments:
