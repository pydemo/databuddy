::Test name: DB2Express_Partition Limit30
	::Description:	Copy only 30 rows from DB2Express partition into Oracle11gTable GetTabnameFromQuery DeleteTargetRecs.
	::Arguments:
