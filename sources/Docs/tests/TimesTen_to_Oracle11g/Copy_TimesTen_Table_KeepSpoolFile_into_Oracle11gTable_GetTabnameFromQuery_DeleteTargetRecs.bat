::Test name: TimesTen_Table KeepSpoolFile
	::Description:	Copy TimesTen table into Oracle11gTable GetTabnameFromQuery DeleteTargetRecs.
	::Arguments:
...
-B qc_job ^
-Y 20150616_074311_075000 ^
-C ".\config\sqlloader.py" ^
-5 ".\config\host_map_v2.py" ^
-6 csv ^
-c TERRY.Timestamp_test_from ^
-j TERRY ^
-x secret ^
-b my_ttdb ^
