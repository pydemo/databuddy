::Test name: SybaseIQ_QueryDir
	::Description:	Read each SQL query file from a directory "C:\Python27\data_migrator_1239_mongo\test\v101\query\query_dir_sy".Copy SybaseIQ query results into Oracle11gSubpartition.
	::Arguments:
