::Test name: SybaseIQ_Table Limit22
	::Description:	Copy only 22 rows from SybaseIQ table into Oracle11gTable GetTabnameFromQuery DeleteTargetRecs.
	::Arguments:
