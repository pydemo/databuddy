::Test name: Exadata_SubpartitionList
	::Description:	Copy Exadata sub-partition into Oracle11gTable GetTabnameFromQuery DeleteTargetRecs.
	::Arguments:
