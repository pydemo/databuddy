::Test name: Exadata_QueryFile keepWhitespace withHeader
	::Description:	Read SQL from a query file "C:\Python27\data_migrator_1239_mongo\test\v101\query\oracle_query.sql".Copy Exadata query results into Oracle11gTable SkipHeader.
	::Arguments:
