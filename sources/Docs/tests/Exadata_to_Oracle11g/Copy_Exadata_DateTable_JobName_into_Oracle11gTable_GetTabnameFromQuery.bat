::Test name: Exadata_DateTable JobName
	::Description:	Copy Exadata table into Oracle11gTable GetTabnameFromQuery.
	::Arguments:
...
-B FROM_ORAEXA_DateTable_JobName_TO_ORA11G_Table_GetTabnameFromQuery ^
-Y 20150616_074408_998000 ^
