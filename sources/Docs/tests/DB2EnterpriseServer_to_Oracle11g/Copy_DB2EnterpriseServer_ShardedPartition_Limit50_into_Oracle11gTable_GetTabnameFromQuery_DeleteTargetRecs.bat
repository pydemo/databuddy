::Test name: DB2EnterpriseServer_ShardedPartition Limit50
	::Description:	Copy only 50 rows from DB2EnterpriseServer sharded partition into Oracle11gTable GetTabnameFromQuery DeleteTargetRecs.
	::Arguments:
