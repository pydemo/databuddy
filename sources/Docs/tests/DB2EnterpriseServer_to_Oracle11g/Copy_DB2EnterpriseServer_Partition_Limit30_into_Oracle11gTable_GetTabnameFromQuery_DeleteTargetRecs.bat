::Test name: DB2EnterpriseServer_Partition Limit30
	::Description:	Copy only 30 rows from DB2EnterpriseServer partition into Oracle11gTable GetTabnameFromQuery DeleteTargetRecs.
	::Arguments:
