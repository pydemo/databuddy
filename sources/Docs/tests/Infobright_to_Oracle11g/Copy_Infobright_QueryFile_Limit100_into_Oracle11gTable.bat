::Test name: Infobright_QueryFile Limit100
	::Description:	Read SQL from a query file "C:\Python27\data_migrator_1239_mongo\test\v101\query\mysql_query.sql".Copy only 100 rows from Infobright query results into Oracle11gTable.
	::Arguments:
