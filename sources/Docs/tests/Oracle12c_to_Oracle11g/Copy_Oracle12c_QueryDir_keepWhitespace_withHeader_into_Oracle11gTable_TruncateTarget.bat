::Test name: Oracle12c_QueryDir keepWhitespace withHeader
	::Description:	Read each SQL query file from a directory "C:\Python27\data_migrator_1239_mongo\test\v101\query\query_dir_ora".Copy Oracle12c query results into Oracle11gTable TruncateTarget.
	::Arguments:
