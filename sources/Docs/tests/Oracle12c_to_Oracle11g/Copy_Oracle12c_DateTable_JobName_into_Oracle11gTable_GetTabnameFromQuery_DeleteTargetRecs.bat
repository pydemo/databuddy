::Test name: Oracle12c_DateTable JobName
	::Description:	Copy Oracle12c table into Oracle11gTable GetTabnameFromQuery DeleteTargetRecs.
	::Arguments:
...
-B FROM_ORA12C_DateTable_JobName_TO_ORA11G_Table_GetTabnameFromQuery_DeleteTargetRecs ^
