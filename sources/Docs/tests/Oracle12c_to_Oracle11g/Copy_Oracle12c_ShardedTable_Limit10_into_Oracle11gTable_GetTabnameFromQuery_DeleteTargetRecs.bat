::Test name: Oracle12c_ShardedTable Limit10
	::Description:	Copy only 10 rows from Oracle12c table into Oracle11gTable GetTabnameFromQuery DeleteTargetRecs.
	::Arguments:
