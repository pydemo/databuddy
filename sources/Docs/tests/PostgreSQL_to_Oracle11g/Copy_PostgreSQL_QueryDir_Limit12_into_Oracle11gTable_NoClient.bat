::Test name: PostgreSQL_QueryDir Limit12
	::Description:	Read each SQL query file from a directory "C:\Python27\data_migrator_1239_mongo\test\v101\query\query_dir_pgres".Copy only 12 rows from PostgreSQL query results into Oracle11gTable NoClient.
	::Arguments:
