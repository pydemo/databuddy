::Test name: Oracle11g_QueryFile trimWhitespace noHeader
	::Description:	Read SQL from a query file "C:\Python27\data_migrator_1239_mongo\test\v101\query\oracle_query.sql".Copy Oracle11g query results into Oracle12cTable TruncateTarget.
	::Arguments:
