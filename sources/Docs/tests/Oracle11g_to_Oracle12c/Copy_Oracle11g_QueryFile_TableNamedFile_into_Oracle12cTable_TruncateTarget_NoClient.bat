::Test name: Oracle11g_QueryFile TableNamedFile
	::Description:	Read SQL from a query file ""C:\Python27\data_migrator_1239_mongo\test\v101\query\SCOTT.TIMESTAMP_TEST_TO.0.sql"".Copy Oracle11g query results into Oracle12cTable TruncateTarget NoClient.
	::Arguments:
