::Test name: Oracle11g_QueryFile Limit10
	::Description:	Read SQL from a query file "C:\Python27\data_migrator_1239_mongo\test\v101\query\oracle_query.sql".Copy only 10 rows from Oracle11g query results into Oracle11gSubpartition TruncateTarget.
	::Arguments:
