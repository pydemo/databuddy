::Test name: SQLServerEnterprise_QueryFile Limit15
	::Description:	Read SQL from a query file "C:\Python27\data_migrator_1239_mongo\test\v101\query\ss_query.sql".Copy only 15 rows from SQLServerEnterprise query results into Oracle11gTable GetTabnameFromQuery.
	::Arguments:
