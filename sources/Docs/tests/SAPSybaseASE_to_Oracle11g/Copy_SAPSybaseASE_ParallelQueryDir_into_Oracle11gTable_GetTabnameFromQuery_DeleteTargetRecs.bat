::Test name: SAPSybaseASE_ParallelQueryDir
	::Description:	Read each SQL query file from a directory "-1".Copy SAPSybaseASE query results into Oracle11gTable GetTabnameFromQuery DeleteTargetRecs.
	::Arguments:
