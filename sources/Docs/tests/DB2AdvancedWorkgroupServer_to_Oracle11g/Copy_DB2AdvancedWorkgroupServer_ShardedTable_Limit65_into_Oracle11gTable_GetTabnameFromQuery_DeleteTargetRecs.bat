::Test name: DB2AdvancedWorkgroupServer_ShardedTable Limit65
	::Description:	Copy only 65 rows from DB2AdvancedWorkgroupServer table into Oracle11gTable GetTabnameFromQuery DeleteTargetRecs.
	::Arguments:
