::Test name: DB2AdvancedWorkgroupServer_ShardedPartition
	::Description:	Copy DB2AdvancedWorkgroupServer sharded partition into Oracle11gTable GetTabnameFromQuery DeleteTargetRecs.
	::Arguments:
