::Test name: InformixIDS_Table KeepSpoolFile
	::Description:	Copy InformixIDS table into Oracle11gTable GetTabnameFromQuery DeleteTargetRecs.
	::Arguments:
