::Test name: InformixIDS_QueryFile
	::Description:	Read SQL from a query file "C:\Python27\data_migrator_1239_mongo\test\v101\query\informix_query.sql".Copy InformixIDS query results into Oracle11gSubpartition TruncateTarget.
	::Arguments:
