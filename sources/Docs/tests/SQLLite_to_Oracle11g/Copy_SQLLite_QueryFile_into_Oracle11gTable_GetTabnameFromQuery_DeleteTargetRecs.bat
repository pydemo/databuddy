::Test name: SQLLite_QueryFile
	::Description:	Read SQL from a query file "C:\Python27\data_migrator_1239_mongo\test\v101\query\sqllite_query.sql".Copy SQLLite query results into Oracle11gTable GetTabnameFromQuery DeleteTargetRecs.
	::Arguments:
