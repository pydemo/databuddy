::Test name: DB2ExpressC_QueryFile Limit10
	::Description:	Read SQL from a query file "C:\Python27\data_migrator_1239_mongo\test\v101\query\db2_query.sql".Copy only 10 rows from DB2ExpressC query results into Oracle11gSubpartition.
	::Arguments:
