::Test name: DB2ExpressC_Partition
	::Description:	Copy DB2ExpressC partition into Oracle11gTable GetTabnameFromQuery DeleteTargetRecs.
	::Arguments:
