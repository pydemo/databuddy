::Test name: DB2DeveloperEdition_Partition Limit30
	::Description:	Copy only 30 rows from DB2DeveloperEdition partition into Oracle11gTable GetTabnameFromQuery DeleteTargetRecs.
	::Arguments:
