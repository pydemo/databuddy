::Test name: DB2DeveloperEdition_ShardedPartition
	::Description:	Copy DB2DeveloperEdition sharded partition into Oracle11gTable GetTabnameFromQuery DeleteTargetRecs.
	::Arguments:
