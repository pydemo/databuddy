...
# Migrating Oracle11g table data to DB2AdvancedWorkgroupServer.
In this example we are going to migrate Oracle11g table data to DB2AdvancedWorkgroupServer.
Migration steps:
...
```  
(sample image)
![Define copy vector for Oracle11g-to-DB2AdvancedWorkgroupServer extract pipeline](https://raw.githubusercontent.com/data-buddy/DataBuddy/master/screenshots/MongoDB/Define_copy_vector_for_Oracle12c-to-MongoDB_copy_pipeline.png "Define copy vector for Oracle11g-to-DB2AdvancedWorkgroupServer copy pipeline.")

## Select Source and Target templates
Next and last step is template selection. Pick one from the source list on the left (`ORA11G_TimestampTable`) and one from the target list on the right (`DBTAWS_Table`):
(sample image)
...
```
############################################################
2015-06-01 11:30:09,022 - ORA11G-DBTAWS - INFO - Done.
2015-06-01 11:30:09,022 - ORA11G-DBTAWS - INFO - Elapsed: 00:00:00
