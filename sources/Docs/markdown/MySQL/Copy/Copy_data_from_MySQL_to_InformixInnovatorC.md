...
# Migrating MySQL table data to InformixInnovatorC.
In this example we are going to migrate MySQL table data to InformixInnovatorC.
Migration steps:
...
```  
(sample image)
![Define copy vector for MySQL-to-InformixInnovatorC extract pipeline](https://raw.githubusercontent.com/data-buddy/DataBuddy/master/screenshots/MongoDB/Define_copy_vector_for_Oracle12c-to-MongoDB_copy_pipeline.png "Define copy vector for MySQL-to-InformixInnovatorC copy pipeline.")

## Select Source and Target templates
Next and last step is template selection. Pick one from the source list on the left (`MYSQL_TimestampTable`) and one from the target list on the right (`INFORC_Table`):
(sample image)
...
```
############################################################
2015-06-01 11:30:09,022 - MYSQL-INFORC - INFO - Done.
2015-06-01 11:30:09,022 - MYSQL-INFORC - INFO - Elapsed: 00:00:00
