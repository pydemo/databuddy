...
# Migrating MySQL table data to MongoDB.
In this example we are going to migrate MySQL table data to MongoDB.
Migration steps:
...
```  
(sample image)
![Define copy vector for MySQL-to-MongoDB extract pipeline](https://raw.githubusercontent.com/data-buddy/DataBuddy/master/screenshots/MongoDB/Define_copy_vector_for_Oracle12c-to-MongoDB_copy_pipeline.png "Define copy vector for MySQL-to-MongoDB copy pipeline.")

## Select Source and Target templates
Next and last step is template selection. Pick one from the source list on the left (`MYSQL_TimestampTable`) and one from the target list on the right (`MONGO_Table`):
(sample image)
...
```
############################################################
2015-06-01 11:30:09,022 - MYSQL-MONGO - INFO - Done.
2015-06-01 11:30:09,022 - MYSQL-MONGO - INFO - Elapsed: 00:00:00
