...
# Migrating SQLServerExpress table data to Oracle11g.
In this example we are going to migrate SQLServerExpress table data to Oracle11g.
Migration steps:
...
```  
(sample image)
![Define copy vector for SQLServerExpress-to-Oracle11g extract pipeline](https://raw.githubusercontent.com/data-buddy/DataBuddy/master/screenshots/MongoDB/Define_copy_vector_for_Oracle12c-to-MongoDB_copy_pipeline.png "Define copy vector for SQLServerExpress-to-Oracle11g copy pipeline.")

## Select Source and Target templates
Next and last step is template selection. Pick one from the source list on the left (`SSEXP_TimestampTable`) and one from the target list on the right (`ORA11G_Table`):
(sample image)
...
```
############################################################
2015-06-01 11:30:09,022 - SSEXP-ORA11G - INFO - Done.
2015-06-01 11:30:09,022 - SSEXP-ORA11G - INFO - Elapsed: 00:00:00
