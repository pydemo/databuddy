...
# Migrating InformixInnovatorC table data to SAPSybaseASE.
In this example we are going to migrate InformixInnovatorC table data to SAPSybaseASE.
Migration steps:
...
```  
(sample image)
![Define copy vector for InformixInnovatorC-to-SAPSybaseASE extract pipeline](https://raw.githubusercontent.com/data-buddy/DataBuddy/master/screenshots/MongoDB/Define_copy_vector_for_Oracle12c-to-MongoDB_copy_pipeline.png "Define copy vector for InformixInnovatorC-to-SAPSybaseASE copy pipeline.")

## Select Source and Target templates
Next and last step is template selection. Pick one from the source list on the left (`INFORC_TimestampTable`) and one from the target list on the right (`SYASE_Table`):
(sample image)
...
```
############################################################
2015-06-01 11:30:09,022 - INFORC-SYASE - INFO - Done.
2015-06-01 11:30:09,022 - INFORC-SYASE - INFO - Elapsed: 00:00:00
