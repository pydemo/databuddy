::Test name: MySQL_QueryFile Limit100
	::Description:	Read SQL from a query file "C:\Users\alex_buz\Documents\GitHub\DataBuddy\sources\qc32\test\v101\query\mysql_query.sql".Extract only 100 rows from MySQL table into CSVDefault.
	::Arguments:
