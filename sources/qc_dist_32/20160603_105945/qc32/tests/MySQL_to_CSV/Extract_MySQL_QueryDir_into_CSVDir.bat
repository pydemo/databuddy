::Test name: MySQL_QueryDir
	::Description:	Read each SQL query file from a directory "C:\Users\alex_buz\Documents\GitHub\DataBuddy\sources\qc32\test\v101\query\query_dir_mysql".Extract MySQL table into CSVDir.
	::Arguments:
