::Test name: MySQL_TimezoneQueryFile
	::Description:	Read SQL from a query file "C:\Users\alex_buz\Documents\GitHub\DataBuddy\sources\qc32\test\v101\query\mysql_query.sql".Copy MySQL query results into MySQLTable.
	::Arguments:
