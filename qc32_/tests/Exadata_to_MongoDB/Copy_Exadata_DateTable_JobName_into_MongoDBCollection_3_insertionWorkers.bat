::Test name: Exadata_DateTable JobName
	::Description:	Copy Exadata table into MongoDBCollection 3 insertionWorkers.
	::Arguments:
...
-B FROM_ORAEXA_DateTable_JobName_TO_MONGO_Collection_3_insertionWorkers ^
-Y 20150614_220311_586000 ^
