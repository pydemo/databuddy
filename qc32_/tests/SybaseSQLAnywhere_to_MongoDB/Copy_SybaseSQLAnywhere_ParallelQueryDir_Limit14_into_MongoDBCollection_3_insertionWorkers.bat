::Test name: SybaseSQLAnywhere_ParallelQueryDir Limit14
	::Description:	Read each SQL query file from a directory "-1".Copy only 14 rows from SybaseSQLAnywhere query results into MongoDBCollection 3 insertionWorkers.
	::Arguments:
