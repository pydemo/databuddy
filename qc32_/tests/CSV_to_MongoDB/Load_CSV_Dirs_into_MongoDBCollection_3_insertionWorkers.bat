::Test name: CSV_Dirs
	::Description:	Read each CSV file from a directory "C:\Python27\data_migrator_1239_mongo\test\v101\data\mongo_data_dir".Load CSV file into MongoDBCollection 3 insertionWorkers.
	::Arguments:
