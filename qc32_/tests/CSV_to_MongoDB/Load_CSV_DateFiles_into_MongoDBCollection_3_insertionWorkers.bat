::Test name: CSV_DateFiles
	::Description:	Load CSV file into MongoDBCollection 3 insertionWorkers.
	::Arguments:
...
-M C:\Temp\qc_log ^
-B qc_job ^
-Y 20150614_220205_509000 ^
-5 ".\config\host_map_v2.py" ^
-6 json ^
-i C:\Python27\data_migrator_1239_mongo\test\v101\data\mongo_shard_0.data;C:\Python27\data_migrator_1239_mongo\test\v101\data\mongo_shard_0.data ^
-y 1000 ^
-u test_user ^
-p tast_pwd ^
-d test ^
