::Test name: Oracle11g_DateTable JobName
	::Description:	Copy Oracle11g table into MongoDBCollection 3 insertionWorkers.
	::Arguments:
...
-B FROM_ORA11G_DateTable_JobName_TO_MONGO_Collection_3_insertionWorkers ^
-Y 20150614_220232_365000 ^
