::Test name: MongoDB_Collection withHeader
	::Description:	Extract MongoDB table into JSONFile.
	::Arguments:
...
-z 27017 ^
-A 1 ^
-g C:\Python27\data_migrator_1239_mongo\JSON_OUT\testMONGO_Collection_withHeader.js