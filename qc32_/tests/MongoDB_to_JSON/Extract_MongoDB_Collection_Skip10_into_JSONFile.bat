::Test name: MongoDB_Collection Skip10
	::Description:	Skip 10 rows and extract MongoDB table into JSONFile.
	::Arguments:
...
-z 27017 ^
-O 1 ^
-g C:\Python27\data_migrator_1239_mongo\JSON_OUT\testMONGO_Collection_Skip10.js