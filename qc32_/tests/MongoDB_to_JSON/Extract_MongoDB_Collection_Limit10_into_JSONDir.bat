::Test name: MongoDB_Collection Limit10
	::Description:	Extract only 10 rows from MongoDB table into JSONDir.
	::Arguments:
...
-n localhost ^
-z 27017 ^
-D C:\Python27\data_migrator_1239_mongo\JSON_OUT