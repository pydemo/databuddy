::Test name: Oracle11G_DateTable JobName
	::Description:	Copy Oracle11G table into Oracle11GTable DeleteTargetRecs.
	::Arguments:
...
-B FROM_ORA11G_DateTable_JobName_TO_ORA11G_Table_DeleteTargetRecs ^
-Y 20150513_194658_280000 ^
