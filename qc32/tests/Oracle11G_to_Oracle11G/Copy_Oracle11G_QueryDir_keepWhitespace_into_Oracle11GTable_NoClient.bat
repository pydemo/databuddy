::Test name: Oracle11G_QueryDir keepWhitespace
	::Description:	Read each SQL query file from a directory "C:\Python27\data_migrator_1239\test\v101\query\query_dir_ora".Copy Oracle11G query results into Oracle11GTable NoClient.
	::Arguments:
