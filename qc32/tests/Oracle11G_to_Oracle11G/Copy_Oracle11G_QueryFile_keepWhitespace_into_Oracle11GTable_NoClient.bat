::Test name: Oracle11G_QueryFile keepWhitespace
	::Description:	Read SQL from a query file "c:\Python27\data_migrator_1239_ddl\test\v101\query\oracle_query.sql".Copy Oracle11G query results into Oracle11GTable NoClient.
	::Arguments:
