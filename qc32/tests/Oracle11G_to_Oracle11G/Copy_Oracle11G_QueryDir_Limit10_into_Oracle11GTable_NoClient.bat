::Test name: Oracle11G_QueryDir Limit10
	::Description:	Read each SQL query file from a directory "C:\Python27\data_migrator_1239\test\v101\query\query_dir_ora".Copy only 10 rows from Oracle11G query results into Oracle11GTable NoClient.
	::Arguments:
