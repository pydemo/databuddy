::Test name: SQLServer7.0_ShardedQueryFile
	::Description:	Read SQL from a query file "c:\Python27\data_migrator_1239_mongo\test\v101\query\ss_query.sql".Copy SQLServer7.0 query results into SQLServerExpressTable.
	::Arguments:
