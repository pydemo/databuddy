::Test name: Oracle11G_QueryDir TableNamedFiles
	::Description:	Read each SQL query file from a directory "C:\Python27\data_migrator_1239_ddl\test\v101\query\query_dir_ora_table_named".Extract Oracle11G table into CSVDefault.
	::Arguments:
