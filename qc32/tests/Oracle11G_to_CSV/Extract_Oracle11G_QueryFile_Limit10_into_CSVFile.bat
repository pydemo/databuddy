::Test name: Oracle11G_QueryFile Limit10
	::Description:	Read SQL from a query file "C:\Python27\data_migrator_1239\test\v101\query\oracle_query.sql".Extract only 10 rows from Oracle11G table into CSVFile.
	::Arguments:
