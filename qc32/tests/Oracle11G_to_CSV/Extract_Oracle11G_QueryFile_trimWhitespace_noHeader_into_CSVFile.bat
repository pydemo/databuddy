::Test name: Oracle11G_QueryFile trimWhitespace noHeader
	::Description:	Read SQL from a query file "C:\Python27\data_migrator_1239_ddl\test\v101\query\oracle_query.sql".Extract Oracle11G table into CSVFile.
	::Arguments:
...
-g C:\Python27\data_migrator_1239_ddl\CSV_OUT\testORA11G_QueryFile_trimWhitespace_noHeader.data