::Test name: Oracle11G_QueryFile TableNamedFile
	::Description:	Read SQL from a query file ""C:\Python27\data_migrator_1239_ddl\test\v101\query\SCOTT.TIMESTAMP_TEST_TO.0.sql"".Extract Oracle11G table into CSVFile.
	::Arguments:
...
-g C:\Python27\data_migrator_1239_ddl\CSV_OUT\testORA11G_QueryFile_TableNamedFile.data