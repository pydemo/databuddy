::Test name: SQLServerExpress_ShardedQueryFile
	::Description:	Read SQL from a query file "c:\Python27\data_migrator_1239_mongo\test\v101\query\ss_query.sql".Copy SQLServerExpress query results into DB2AdvancedEnterpriseServerTable.
	::Arguments:
