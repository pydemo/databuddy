::Test name: Oracle8i_QueryFile keepWhitespace withHeader
	::Description:	Read SQL from a query file "C:\Python27\data_migrator_1239_mongo\test\v101\query\oracle_query.sql".Copy Oracle8i query results into SQLServerExpressTable.
	::Arguments:
...
::	-q[--query_sql_file] is "Input file with Oracle 8i query sql."
