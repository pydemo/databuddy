::Test name: Oracle8i_QueryDir keepWhitespace withHeader
	::Description:	Read each SQL query file from a directory "c:\Python27\data_migrator_1239_mongo\test\v101\query\query_dir_ora".Copy Oracle8i query results into SQLServerExpressTable.
	::Arguments:
...
::	-Q[--query_sql_dir] is "Input dir with Oracle 8i query files sql."
::	-j[--from_user] is "Oracle 8i source user."
::	-x[--from_passwd] is "Oracle 8i source user password."
::	-b[--from_db_name] is "Oracle 8i source database."
::	-e[--nls_date_format] is "nls_date_format for source."
::	-m[--nls_timestamp_format] is "nls_timestamp_format for source."
::	-O[--nls_timestamp_tz_format] is "nls_timestamp_tz_format for source."
::	-A[--header] is "Include header to Oracle 8i extract."
::	-W[--keep_whitespace] is "Keep whitespace from CHAR type in "Oracle 8i" extract."
