::Test name: TimesTen_QueryFile Limit15
	::Description:	Read SQL from a query file "C:\Python27\data_migrator_1239_mongo\test\v101\query\timesten_query.sql".Copy only 15 rows from TimesTen query results into MongoDBCollection 3 insertionWorkers.
	::Arguments:
