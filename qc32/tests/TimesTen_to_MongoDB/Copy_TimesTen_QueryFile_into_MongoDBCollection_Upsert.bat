::Test name: TimesTen_QueryFile
	::Description:	Read SQL from a query file "C:\Python27\data_migrator_1239_mongo\test\v101\query\timesten_query.sql".Copy TimesTen query results into MongoDBCollection Upsert.
	::Arguments:
