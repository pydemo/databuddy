::Test name: SQLServer2000_Partition Limit20
	::Description:	Copy only 20 rows from SQLServer2000 partition into SQLServerExpressTable.
	::Arguments:
