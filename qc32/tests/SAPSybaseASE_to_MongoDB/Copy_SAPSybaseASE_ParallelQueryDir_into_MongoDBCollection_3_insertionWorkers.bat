::Test name: SAPSybaseASE_ParallelQueryDir
	::Description:	Read each SQL query file from a directory "-1".Copy SAPSybaseASE query results into MongoDBCollection 3 insertionWorkers.
	::Arguments:
