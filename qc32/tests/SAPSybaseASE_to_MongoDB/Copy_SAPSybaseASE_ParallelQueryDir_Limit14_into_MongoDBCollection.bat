::Test name: SAPSybaseASE_ParallelQueryDir Limit14
	::Description:	Read each SQL query file from a directory "-1".Copy only 14 rows from SAPSybaseASE query results into MongoDBCollection.
	::Arguments:
