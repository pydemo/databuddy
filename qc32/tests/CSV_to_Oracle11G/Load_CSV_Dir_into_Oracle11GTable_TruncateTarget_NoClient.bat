::Test name: CSV_Dir
	::Description:	Read each CSV file from a directory "C:\Python27\data_migrator_1239\test\v101\data\ora_data_dir".Load CSV file into Oracle11GTable TruncateTarget NoClient.
	::Arguments:
