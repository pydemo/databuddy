::Test name: CSV_Dir Limit10
	::Description:	Read each CSV file from a directory "C:\Python27\data_migrator_1239\test\v101\data\ora_data_dir".Load only 10 rows from CSV file into Oracle11GTable TruncateTarget NoClient.
	::Arguments:
...
python -c "print 'y\ny'" |C:\Python27\qc_dist_32\20150210_163137\qc32\qc32.exe ^
-w csv2ora11g ^
-o 1 ^
-r 1 ^
-t "|" ^
