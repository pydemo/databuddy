::Test name: CSV_DirsSkip1
	::Description:	Read each CSV file from a directory "c:\Python27\data_migrator_1239\test\v101\data\ora_data_dir_1;c:\Python27\data_migrator_1239\test\v101\data\ora_data_dir_2".Skip 1 rows and load CSV file into Oracle11GPartition TruncateTarget.
	::Arguments:
