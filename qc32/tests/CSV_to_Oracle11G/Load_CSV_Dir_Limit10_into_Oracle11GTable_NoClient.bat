::Test name: CSV_Dir Limit10
	::Description:	Read each CSV file from a directory "C:\Python27\data_migrator_1239\test\v101\data\ora_data_dir".Load only 10 rows from CSV file into Oracle11GTable NoClient.
	::Arguments:
