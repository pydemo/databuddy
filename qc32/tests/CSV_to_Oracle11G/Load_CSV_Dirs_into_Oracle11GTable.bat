::Test name: CSV_Dirs
	::Description:	Read each CSV file from a directory "C:\Python27\data_migrator_1239\test\v101\data\ora_data_dir_1;C:\Python27\data_migrator_1239\test\v101\data\ora_data_dir_2".Load CSV file into Oracle11GTable.
	::Arguments:
