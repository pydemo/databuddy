...
-M C:\Temp\qc_log ^
-B qc_job ^
-Y 20150513_194704_649000 ^
-C "C:\Python27\data_migrator_1239\config\loader\sqlloader.yaml" ^
-5 ".\config\host_map_v2.py" ^
-i C:\Python27\data_migrator_1239_ddl\test\v101\data\oracle_shard_0_dt.data;C:\Python27\data_migrator_1239_ddl\test\v101\data\oracle_shard_0_dt.data ^
-y 1000 ^
-u SCOTT ^
-p tiger ^
-d orcl ^
