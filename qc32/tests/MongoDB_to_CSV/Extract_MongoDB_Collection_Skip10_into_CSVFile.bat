::Test name: MongoDB_Collection Skip10
	::Description:	Skip 10 rows and extract MongoDB table into CSVFile.
	::Arguments:
...
-z 27017 ^
-S 1 ^
-g C:\Python27\data_migrator_1239_mongo\CSV_OUT\testMONGO_Collection_Skip10.csv