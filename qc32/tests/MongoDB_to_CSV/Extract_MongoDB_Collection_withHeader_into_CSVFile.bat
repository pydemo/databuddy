::Test name: MongoDB_Collection withHeader
	::Description:	Extract MongoDB table into CSVFile.
	::Arguments:
...
-z 27017 ^
-A 1 ^
-g C:\Python27\data_migrator_1239_mongo\CSV_OUT\testMONGO_Collection_withHeader.csv