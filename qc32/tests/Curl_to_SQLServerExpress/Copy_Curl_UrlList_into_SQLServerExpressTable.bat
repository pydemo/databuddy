...
::	-urls[--url_list] is "List of input URLs."
...
-B qc_job ^
-Y 20150908_192622_913000 ^
-5 ".\config\host_map\host_map.py" ^
-6 csv ^
-dbg 1 ^
-urls http://oatsreportable.finra.org/OATSReportableSecurities-SOD.txt,http://oatsreportable.finra.org/OATSReportableSecurities-SOD.txt ^
-u sa ^
-p 198Morgan ^
-d master ^
