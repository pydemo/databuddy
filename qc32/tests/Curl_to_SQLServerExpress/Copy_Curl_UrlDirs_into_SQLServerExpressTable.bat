::Test name: Curl_UrlDirs
	::Description:	Read each CSV file from a directory "-1".Copy Curl table into SQLServerExpressTable.
	::Arguments:
...
::	-urldirs[--url_dirs] is "Coma separated list of input dirs of files containing URLs."
...
-B qc_job ^
-Y 20150908_192622_944000 ^
-5 ".\config\host_map\host_map.py" ^
-6 csv ^
-dbg 1 ^
-urldirs C:\Python27\data_migrator_1239_mongo\test\v101\data\URL_Dir_0,C:\Python27\data_migrator_1239_mongo\test\v101\data\URL_Dir_1 ^
-u sa ^
-p 198Morgan ^
-d master ^
