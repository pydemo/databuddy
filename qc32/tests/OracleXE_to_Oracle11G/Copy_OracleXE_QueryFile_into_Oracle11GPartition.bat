::Test name: OracleXE_QueryFile
	::Description:	Read SQL from a query file "C:\Python27\data_migrator_1239\test\v101\query\oracle_query.sql".Copy OracleXE query results into Oracle11GPartition.
	::Arguments:
