::Test name: OracleXE_QueryDir
	::Description:	Read each SQL query file from a directory "c:\Python27\data_migrator_1239_ddl\test\v101\query\query_dir_ora".Copy OracleXE query results into Oracle11GTable DeleteTargetRecs.
	::Arguments:
