::Test name: OracleXE_QueryDir
	::Description:	Read each SQL query file from a directory "c:\Python27\data_migrator_1239\test\v101\query\query_dir_ora".Copy OracleXE query results into Oracle11GTable TruncateTarget NoClient.
	::Arguments:
...
python -c "print 'y\ny'" |c:\Python27\qc_dist_32\20150217_133056\qc32\qc32.exe ^
-w oraxe2ora11g ^
-o 1 ^
-r 1 ^
-t "|" ^
