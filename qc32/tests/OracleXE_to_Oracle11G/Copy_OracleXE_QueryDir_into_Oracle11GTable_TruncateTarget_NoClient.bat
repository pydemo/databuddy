::Test name: OracleXE_QueryDir
	::Description:	Read each SQL query file from a directory "c:\Python27\data_migrator_1239_ddl\test\v101\query\query_dir_ora".Copy OracleXE query results into Oracle11GTable TruncateTarget NoClient.
	::Arguments:
...
::	-j[--from_user] is "Oracle XE source user."
::	-x[--from_passwd] is "Oracle XE source user password."
::	-b[--from_db_name] is "Oracle XE source database."
...
-Q c:\Python27\data_migrator_1239_ddl\test\v101\query\query_dir_ora ^
-j SCOTT ^
-x tiger ^
-b orcl_ol7 ^
-e "YYYY-MM-DD HH24.MI.SS" ^
-m "YYYY-MM-DD HH24.MI.SS.FF2" ^
-z "YYYY-MM-DD HH:MI:SS.FF2 TZH:TZM" ^
-A "C:\app\alex_buz\product\11.2.0\dbhome_2\BIN" ^
-u SCOTT ^
-p tiger ^
-d (DESCRIPTION=(ADDRESS=(PROTOCOL=TCP)(HOST=192.168.15.47)(PORT=1521))(CONNECT_DATA=(SERVER=DEDICATED)(SERVICE_NAME=orcl.localdomain))) ^
