::Test name: GenericFile_FileList
	::Description:	Load GenericFile table into SQLServerExpressTable.
	::Arguments:
...
-B qc_job ^
-Y 20150908_192615_231000 ^
-5 ".\config\host_map\host_map.py" ^
-dbg 1 ^
-i C:\tmp\qctest\pscp_test.zip,C:\tmp\qctest\ProcessExplorer.zip ^
-u sa ^
-p 198Morgan ^
-d master ^
