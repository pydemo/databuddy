::Test name: GenericFile_DirList
	::Description:	Read each CSV file from a directory "C:\tmp\qctest,C:\tmp\qctest".Load GenericFile table into SQLServerExpressTable.
	::Arguments:
...
-B qc_job ^
-Y 20150908_192615_213000 ^
-5 ".\config\host_map\host_map.py" ^
-dbg 1 ^
-I C:\tmp\qctest,C:\tmp\qctest ^
-u sa ^
-p 198Morgan ^
-d master ^
