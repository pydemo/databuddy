::Test name: MongoDB_Collection Limit10
	::Description:	Extract only 10 rows from MongoDB table into JSONFile.
	::Arguments:
...
-n localhost ^
-z 27017 ^
-g C:\Python27\data_migrator_1239_mongo\JSON_OUT\testMONGO_Collection_Limit10.js