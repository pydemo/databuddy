::Test name: SQLServerExpress_Table KeepSpoolFile
	::Description:	Extract SQLServerExpress table into GenericFileSingleFile.
	::Arguments:
...
-g C:\Python27\data_migrator_1239_mongo\CSV_OUT\testSSEXP_Table_KeepSpoolFile.csv