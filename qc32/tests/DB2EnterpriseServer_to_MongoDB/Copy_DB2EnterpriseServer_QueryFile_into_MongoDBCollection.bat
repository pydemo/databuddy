::Test name: DB2EnterpriseServer_QueryFile
	::Description:	Read SQL from a query file "C:\Python27\data_migrator_1239_mongo\test\v101\query\db2_query.sql".Copy DB2EnterpriseServer query results into MongoDBCollection.
	::Arguments:
