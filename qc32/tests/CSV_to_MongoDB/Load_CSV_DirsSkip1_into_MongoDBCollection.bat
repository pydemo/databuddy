::Test name: CSV_DirsSkip1
	::Description:	Read each CSV file from a directory "C:\Python27\data_migrator_1239_mongo\test\v101\data\mongo_data_dir".Skip 1 rows and load CSV file into MongoDBCollection.
	::Arguments:
