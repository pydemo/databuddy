::Test name: MySQL_QueryDir
	::Description:	Read each SQL query file from a directory "C:\Python27\data_migrator_1239_12c\test\v101\query\query_dir_mysql".Extract MySQL table into CSVDefault.
	::Arguments:
