::Test name: SQLServerExpress_QueryFile Limit15
	::Description:	Read SQL from a query file "c:\Python27\data_migrator_1239_mongo\test\v101\query\ss_query.sql".Copy only 15 rows from SQLServerExpress query results into SQLServer2005Table.
	::Arguments:
