::Test name: MySQL_QueryDir Limit333
	::Description:	Read each SQL query file from a directory "C:\Python27\data_migrator_1239_12c\test\v101\query\query_dir_mysql".Extract only 333 rows from MySQL query results into DDLDir.
	::Arguments:
