::Test name: SQLServer2012_ShardedQueryFile
	::Description:	Read SQL from a query file "C:\Python27\data_migrator_1239_mongo\test\v101\query\ss_query.sql".Copy SQLServer2012 query results into SQLServerExpressTable.
	::Arguments:
