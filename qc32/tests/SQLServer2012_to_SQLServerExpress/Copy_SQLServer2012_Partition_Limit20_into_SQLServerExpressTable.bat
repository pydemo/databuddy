::Test name: SQLServer2012_Partition Limit20
	::Description:	Copy only 20 rows from SQLServer2012 partition into SQLServerExpressTable.
	::Arguments:
