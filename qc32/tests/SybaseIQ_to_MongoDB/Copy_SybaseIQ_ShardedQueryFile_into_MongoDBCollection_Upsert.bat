::Test name: SybaseIQ_ShardedQueryFile
	::Description:	Read SQL from a query file "C:\Python27\data_migrator_1239_mongo\test\v101\query\sybase_query.sql".Copy SybaseIQ query results into MongoDBCollection Upsert.
	::Arguments:
