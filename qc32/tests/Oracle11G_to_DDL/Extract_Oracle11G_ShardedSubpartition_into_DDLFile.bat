::Test name: Oracle11G_ShardedSubpartition
	::Description:	Extract Oracle11G sharded sub-partition into DDLFile.
	::Arguments:
...
-g C:\Python27\data_migrator_1239_ddl\DDL_OUT\testORA11G_ShardedSubpartition.ddl