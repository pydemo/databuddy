::Test name: Oracle11G_Subpartition KeepSpoolFile
	::Description:	Extract Oracle11G sub-partition into DDLFile.
	::Arguments:
...
-g C:\Python27\data_migrator_1239_ddl\DDL_OUT\testORA11G_Subpartition_KeepSpoolFile.ddl