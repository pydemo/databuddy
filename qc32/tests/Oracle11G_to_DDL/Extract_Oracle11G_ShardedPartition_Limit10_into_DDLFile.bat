::Test name: Oracle11G_ShardedPartition Limit10
	::Description:	Extract only 10 rows from Oracle11G sharded partition into DDLFile.
	::Arguments:
...
-g C:\Python27\data_migrator_1239_ddl\DDL_OUT\testORA11G_ShardedPartition_Limit10.ddl