::Test name: SybaseSQLAnywhere_ParallelQueryDir
	::Description:	Read each SQL query file from a directory "-1".Copy SybaseSQLAnywhere query results into MongoDBCollection 3 insertionWorkers.
	::Arguments:
