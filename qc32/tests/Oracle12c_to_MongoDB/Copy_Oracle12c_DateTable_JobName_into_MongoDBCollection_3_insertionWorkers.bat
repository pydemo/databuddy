::Test name: Oracle12c_DateTable JobName
	::Description:	Copy Oracle12c table into MongoDBCollection 3 insertionWorkers.
	::Arguments:
...
-B FROM_ORA12C_DateTable_JobName_TO_MONGO_Collection_3_insertionWorkers ^
-Y 20150614_220256_995000 ^
