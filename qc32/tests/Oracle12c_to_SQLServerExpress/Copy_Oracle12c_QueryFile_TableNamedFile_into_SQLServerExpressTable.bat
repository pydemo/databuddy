::Test name: Oracle12c_QueryFile TableNamedFile
	::Description:	Read SQL from a query file ""c:\Python27\data_migrator_1239_mongo\test\v101\query\SCOTT.TIMESTAMP_TEST_TO.0.sql"".Copy Oracle12c query results into SQLServerExpressTable.
	::Arguments:
