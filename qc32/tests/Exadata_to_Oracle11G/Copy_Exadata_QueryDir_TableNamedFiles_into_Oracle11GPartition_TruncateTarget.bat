::Test name: Exadata_QueryDir TableNamedFiles
	::Description:	Read each SQL query file from a directory "c:\Python27\data_migrator_1239_ddl\test\v101\query\query_dir_ora_table_named".Copy Exadata query results into Oracle11GPartition TruncateTarget.
	::Arguments:
