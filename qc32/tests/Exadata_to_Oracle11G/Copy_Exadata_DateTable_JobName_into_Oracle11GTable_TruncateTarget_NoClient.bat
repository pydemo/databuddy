::Test name: Exadata_DateTable JobName
	::Description:	Copy Exadata table into Oracle11GTable TruncateTarget NoClient.
	::Arguments:
...
-B FROM_ORAEXA_DateTable_JobName_TO_ORA11G_Table_TruncateTarget_NoClient ^
