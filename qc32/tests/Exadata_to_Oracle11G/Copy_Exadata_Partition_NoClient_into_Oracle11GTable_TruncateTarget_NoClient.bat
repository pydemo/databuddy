::Test name: Exadata_Partition NoClient
	::Description:	Copy Exadata partition into Oracle11GTable TruncateTarget NoClient.
	::Arguments:
...
-j SCOTT ^
-x tiger ^
-b (DESCRIPTION=(ADDRESS=(PROTOCOL=TCP)(HOST=192.168.15.47)(PORT=1521))(CONNECT_DATA=(SERVER=DEDICATED)(SERVICE_NAME=orcl.localdomain))) ^
