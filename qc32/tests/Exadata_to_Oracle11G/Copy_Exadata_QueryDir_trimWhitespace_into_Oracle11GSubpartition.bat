::Test name: Exadata_QueryDir trimWhitespace
	::Description:	Read each SQL query file from a directory "c:\Python27\data_migrator_1239\test\v101\query\query_dir_ora".Copy Exadata query results into Oracle11GSubpartition.
	::Arguments:
