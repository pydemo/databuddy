::Test name: Exadata_QueryDir Limit10
	::Description:	Read each SQL query file from a directory "c:\Python27\data_migrator_1239_ddl\test\v101\query\query_dir_ora".Copy only 10 rows from Exadata query results into Oracle11GSubpartition.
	::Arguments:
