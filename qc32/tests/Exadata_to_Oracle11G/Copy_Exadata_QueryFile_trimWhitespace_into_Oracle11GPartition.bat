::Test name: Exadata_QueryFile trimWhitespace
	::Description:	Read SQL from a query file "c:\Python27\data_migrator_1239_ddl\test\v101\query\oracle_query.sql".Copy Exadata query results into Oracle11GPartition.
	::Arguments:
