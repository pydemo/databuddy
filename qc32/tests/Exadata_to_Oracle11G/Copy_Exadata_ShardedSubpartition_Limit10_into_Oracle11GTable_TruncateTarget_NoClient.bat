::Test name: Exadata_ShardedSubpartition Limit10
	::Description:	Copy only 10 rows from Exadata sharded sub-partition into Oracle11GTable TruncateTarget NoClient.
	::Arguments:
