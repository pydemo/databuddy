::Test name: InformixInnovatorC_ParallelQueryDir Limit30
	::Description:	Read each SQL query file from a directory "C:\Python27\data_migrator_1239_mongo\test\v101\query\query_dir_infor".Copy only 30 rows from InformixInnovatorC query results into MongoDBCollection Upsert.
	::Arguments:
