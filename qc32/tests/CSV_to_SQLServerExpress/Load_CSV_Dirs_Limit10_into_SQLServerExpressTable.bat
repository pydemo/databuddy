::Test name: CSV_Dirs Limit10
	::Description:	Read each CSV file from a directory ".\test\v101\data\ss_data_dir".Load only 10 rows from CSV file into SQLServerExpressTable.
	::Arguments:
