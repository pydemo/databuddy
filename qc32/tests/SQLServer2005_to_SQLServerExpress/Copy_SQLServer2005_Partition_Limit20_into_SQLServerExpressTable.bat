::Test name: SQLServer2005_Partition Limit20
	::Description:	Copy only 20 rows from SQLServer2005 partition into SQLServerExpressTable.
	::Arguments:
