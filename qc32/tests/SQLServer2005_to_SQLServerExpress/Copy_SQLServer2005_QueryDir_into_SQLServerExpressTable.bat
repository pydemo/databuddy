::Test name: SQLServer2005_QueryDir
	::Description:	Read each SQL query file from a directory "C:\Python27\data_migrator_1239_mongo\test\v101\query\query_dir_ss".Copy SQLServer2005 query results into SQLServerExpressTable.
	::Arguments:
