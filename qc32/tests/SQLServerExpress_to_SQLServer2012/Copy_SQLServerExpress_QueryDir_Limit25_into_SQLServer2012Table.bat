::Test name: SQLServerExpress_QueryDir Limit25
	::Description:	Read each SQL query file from a directory "c:\Python27\data_migrator_1239_mongo\test\v101\query\query_dir_ss".Copy only 25 rows from SQLServerExpress query results into SQLServer2012Table.
	::Arguments:
...
::	-u[--to_user] is "Target SQL Server 2012 db user."
::	-p[--to_passwd] is "SQL Server 2012 user password."
::	-d[--to_db_name] is "SQL Server 2012 database."
::	-s[--to_db_server] is "SQL Server 2012 instance name."
::	-a[--to_table] is "To table."
::	-Z[--target_client_home] is "Path to SQL Server 2012 client home bin dir."	
