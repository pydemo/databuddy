::Test name: SQLServerExpress_QueryDir
	::Description:	Read each SQL query file from a directory "c:\Python27\data_migrator_1239_mongo\test\v101\query\query_dir_ss".Copy SQLServerExpress query results into Oracle12cTable NoClient.
	::Arguments:
