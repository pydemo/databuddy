::Test name: MySQL_QueryDir
	::Description:	Read each SQL query file from a directory "c:\Python27\data_migrator_1239_mongo\test\v101\query\query_dir_mysql".Copy MySQL query results into SQLServerExpressTable.
	::Arguments:
