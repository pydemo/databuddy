::Test name: Pscp_FileList
	::Description:	Copy Pscp table into SQLServerExpressTable.
	::Arguments:
...
::	-frfl[--from_remote_files] is "From remote file list. One or more coma separated file names (in command line)."
...
-fusr oracle ^
-fsrv 192.168.15.227 ^
-frfl /tmp/qctest/pscp_test.zip,/tmp/qctest/ProcessExplorer.zip ^
-u sa ^
-p 198Morgan ^
-d master ^
