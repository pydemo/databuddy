::Test name: SQLServer2014_Partition Limit20
	::Description:	Copy only 20 rows from SQLServer2014 partition into SQLServerExpressTable.
	::Arguments:
