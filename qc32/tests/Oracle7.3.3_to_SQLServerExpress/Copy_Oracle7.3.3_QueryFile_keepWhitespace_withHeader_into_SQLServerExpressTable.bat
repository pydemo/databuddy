::Test name: Oracle7.3.3_QueryFile keepWhitespace withHeader
	::Description:	Read SQL from a query file "c:\Python27\data_migrator_1239_mongo\test\v101\query\oracle_query.sql".Copy Oracle7.3.3 query results into SQLServerExpressTable.
	::Arguments:
...
::	-q[--query_sql_file] is "Input file with Oracle 7.3.3 query sql."
