::Test name: Oracle7.3.3_QueryFile TableNamedFile
	::Description:	Read SQL from a query file ""c:\Python27\data_migrator_1239_mongo\test\v101\query\SCOTT.TIMESTAMP_TEST_TO.0.sql"".Copy Oracle7.3.3 query results into SQLServerExpressTable.
	::Arguments:
