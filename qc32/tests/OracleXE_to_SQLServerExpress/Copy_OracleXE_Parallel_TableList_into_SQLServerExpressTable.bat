::Test name: OracleXE_Parallel TableList
	::Description:	Copy OracleXE table into SQLServerExpressTable.
	::Arguments:
...
-B qc_job ^
-Y 20150723_234258_026000 ^
-5 ".\config\host_map\host_map.py" ^
-6 csv ^
-dbg 1 ^
-j SCOTT.Timestamp_test_from,SCOTT.Timestamp_test_from_2 ^
-O SCOTT ^
-A tiger ^
-W orcl ^
-u sa ^
