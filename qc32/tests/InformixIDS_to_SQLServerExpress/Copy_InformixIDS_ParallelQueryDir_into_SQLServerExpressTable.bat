::Test name: InformixIDS_ParallelQueryDir
	::Description:	Read each SQL query file from a directory "c:\Python27\data_migrator_1239_mongo\test\v101\query\query_dir_infor".Copy InformixIDS query results into SQLServerExpressTable.
	::Arguments:
