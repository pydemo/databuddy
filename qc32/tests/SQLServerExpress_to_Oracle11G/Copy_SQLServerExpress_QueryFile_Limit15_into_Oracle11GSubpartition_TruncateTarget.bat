::Test name: SQLServerExpress_QueryFile Limit15
	::Description:	Read SQL from a query file "C:\Python27\data_migrator_1239_ddl\test\v101\query\ss_query.sql".Copy only 15 rows from SQLServerExpress query results into Oracle11GSubpartition TruncateTarget.
	::Arguments:
