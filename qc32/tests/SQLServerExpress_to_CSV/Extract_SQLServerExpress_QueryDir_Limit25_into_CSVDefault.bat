::Test name: SQLServerExpress_QueryDir Limit25
	::Description:	Read each SQL query file from a directory "C:\Python27\data_migrator_1239_mongo\test\v101\query\query_dir_ss".Extract only 25 rows from SQLServerExpress table into CSVDefault.
	::Arguments:
