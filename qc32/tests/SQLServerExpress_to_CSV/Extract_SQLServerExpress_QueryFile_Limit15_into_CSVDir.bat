::Test name: SQLServerExpress_QueryFile Limit15
	::Description:	Read SQL from a query file "C:\Python27\data_migrator_1239_ddl\test\v101\query\ss_query.sql".Extract only 15 rows from SQLServerExpress table into CSVDir.
	::Arguments:
