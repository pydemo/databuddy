::Test name: SQLServerExpress_QueryDir
	::Description:	Read each SQL query file from a directory "C:\Python27\data_migrator_1239_ddl\test\v101\query\query_dir_ss".Extract SQLServerExpress table into CSVDir.
	::Arguments:
