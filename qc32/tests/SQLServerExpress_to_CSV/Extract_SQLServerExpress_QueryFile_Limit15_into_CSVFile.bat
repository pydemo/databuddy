::Test name: SQLServerExpress_QueryFile Limit15
	::Description:	Read SQL from a query file "c:\Python27\data_migrator_1239_mongo\test\v101\query\ss_query.sql".Extract only 15 rows from SQLServerExpress table into CSVFile.
	::Arguments:
