::Test name: PostgreSQL_ShardedQueryFile
	::Description:	Read SQL from a query file "C:\Python27\data_migrator_1239_mongo\test\v101\query\postgre_query.sql".Copy PostgreSQL query results into MongoDBCollection.
	::Arguments:
