::Test name: Oracle9i_QueryFile keepWhitespace withHeader
	::Description:	Read SQL from a query file "c:\Python27\data_migrator_1239_mongo\test\v101\query\oracle_query.sql".Copy Oracle9i query results into SQLServerExpressTable.
	::Arguments:
...
::	-q[--query_sql_file] is "Input file with Oracle 9i query sql."
