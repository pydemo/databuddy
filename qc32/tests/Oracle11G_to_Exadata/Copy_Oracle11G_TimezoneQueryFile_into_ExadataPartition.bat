::Test name: Oracle11G_TimezoneQueryFile
	::Description:	Read SQL from a query file "C:\Python27\data_migrator_1239\test\v101\query\oracle_query.sql".Copy Oracle11G query results into ExadataPartition.
	::Arguments:
