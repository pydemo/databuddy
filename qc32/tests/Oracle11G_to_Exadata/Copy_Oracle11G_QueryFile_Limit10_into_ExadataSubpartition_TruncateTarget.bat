::Test name: Oracle11G_QueryFile Limit10
	::Description:	Read SQL from a query file "c:\Python27\data_migrator_1239_ddl\test\v101\query\oracle_query.sql".Copy only 10 rows from Oracle11G query results into ExadataSubpartition TruncateTarget.
	::Arguments:
