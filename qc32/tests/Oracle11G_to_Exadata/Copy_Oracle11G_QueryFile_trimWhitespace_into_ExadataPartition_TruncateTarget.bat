::Test name: Oracle11G_QueryFile trimWhitespace
	::Description:	Read SQL from a query file "c:\Python27\data_migrator_1239_ddl\test\v101\query\oracle_query.sql".Copy Oracle11G query results into ExadataPartition TruncateTarget.
	::Arguments:
