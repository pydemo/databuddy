::Test name: Oracle11G_QueryFile TableNamedFile
	::Description:	Read SQL from a query file ""c:\Python27\data_migrator_1239_ddl\test\v101\query\SCOTT.TIMESTAMP_TEST_TO.0.sql"".Copy Oracle11G query results into ExadataTable.
	::Arguments:
