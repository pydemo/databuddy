...
pfrom[dbkey]['from_partition_list']=  {'short':'-Pl','long':'--from_partition_list', 	'type':str, 'default':None, 'help':'(From) Coma separated partition list.'}
pfrom[dbkey]['from_sub_partition']=  {'short':'-S','long':'--from_sub_partition', 	'type':str, 'default':None, 'help':'From sub-partition.'}
pfrom[dbkey]['from_sub_partition_list']=  {'short':'-Sl','long':'--from_sub_partition_list', 	'type':str, 'default':None, 'help':'(From) Coma separated sub-partition list.'}
