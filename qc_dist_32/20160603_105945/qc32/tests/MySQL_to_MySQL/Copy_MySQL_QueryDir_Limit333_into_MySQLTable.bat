::Test name: MySQL_QueryDir Limit333
	::Description:	Read each SQL query file from a directory "C:\Users\alex_buz\Documents\GitHub\DataBuddy\sources\qc32\test\v101\query\query_dir_mysql".Copy only 333 rows from MySQL query results into MySQLTable.
	::Arguments:
